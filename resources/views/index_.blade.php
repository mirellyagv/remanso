    ...
    <div class="backgroundLogin ">
            ...
            <div class="row">
                ...
                <div class="mb-3">
                    <div class="input-group" id="show_hide_password">
                        <input type="password" class="form-control form-remanso" id="password"
                            placeholder="Contraseña">
                        <div class="input-group-append form-remanso">
                            <span class="input-group-text form-remanso">
                                <a class="hidePass" href="">
                ...
                <div class="mb-3">
                    <a href="#" class="btn btn-danger form-remanso BtnverdeRemanso" id="btnIngresar"
                        style="width: -webkit-fill-available;">Ingresar</a>
                </div>
                <div class="mb-3" style="text-align: end">
                    <a class="verdeRemanso" href="#" data-bs-toggle="tooltip" data-bs-placement="bottom"
                        data-bs-title="Comuniquese con su area de soporte técnico">Olvide mi contraseña</a>
                </div>
            </div>
        </div>
        ...
        <div class="m-auto d-block d-md-none" style="width: 80%;">
            <div class="row">
                ...
                <div class="mb-3">
                    <div class="input-group" id="show_hide_password">
                        <input type="password" class="form-control form-remanso" id="passwordM"
                            placeholder="Contraseña">
                        <div class="input-group-append form-remanso">
                            <span class="input-group-text form-remanso"><a class="hidePass" href=""><i
                                        class="bi bi-eye-slash-fill" aria-hidden="true"></i></a></span>
                        </div>
                    </div>
                </div>
                <div class="mb-3">
                    <a href="#" class="btn btn-danger form-remanso BtnverdeRemanso"
                        style="width: -webkit-fill-available;" id="loginBtn1">Ingresar</a>
                </div>
                <div class="mb-3">
                    <a class="verdeRemanso" href="#" data-bs-toggle="tooltip" data-bs-placement="bottom"
                        data-bs-title="Comuniquese con su area de soporte técnico">Olvide mi contraseña</a>
