<x-layouts.app title="Registro" meta-description="Registro de ventas meta description">
    ...
    <div id="overlay_load" class="overlay_lomas">
        <img src="{{ asset('images/logotipoWeb.svg') }}" alt="login" class="fading-element">
    </div>
    <main class="main" id="main">
                        ...
                        <div class="card ">
                            <div class="row">
                                ...
                                <div class="col-1 col-md-1">
                                    <div class="form-group form-remanso">
                                        <h5>
                                            <input type="checkbox" data-toggle="toggle" id="AprobarVenta"
                                                data-onlabel="SI" data-offlabel = "NO" data-onstyle ="success"
                                                unchecked>
                                        </h5>
                                    </div>
                                </div>
                                ...
                                <div class="col-1 col-md-1">
                                    <div class="form-group form-remanso">
                                        <h5>
                                            <input type="checkbox" data-toggle="toggle" id="tipoNec" data-onlabel="NI"
                                                data-offlabel = "NF" data-onstyle ="success" checked>
                                        </h5>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-flush" id="accordionExample">
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#collapseTitular" aria-expanded="true"
                                            aria-controls="collapseTitular">
                                            <h4>Datos del Titular</h4>
                                        </button>
                                    </h2>
                                    <div id="collapseTitular" class="accordion-collapse collapse show"
                                        data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <br>
                                            <div class="row">
                                                <div class="col-md-3 mb-3">
                                                    <label for="inputText" class="col-form-label">(*) Tipo de Documento:
                                                    </label>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <select name="tipoDocRegVta" id="tipoDocRegVta"
                                                        class="form-select form-remanso" required>
                                                    </select>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label for="inputText" class="col-form-label">(*) Núm. de Documento:
                                                    </label>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <input type="text" class="form-control form-remanso align-right"
                                                        name="numDocRegVta" id="numDocRegVta" required>
                                                </div>
                                            </div>
                                            <div id="nombre">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 mb-3">
                                                        <input type="text"
                                                            class="form-control form-remanso letras-only"
                                                            name="nombresRegVta" id="nombresRegVta" required>
                                                    </div>
                                                    <div class="col-md-3 mb-3">
                                                        <label for="inputText" class="col-form-label">(*) Apellido
                                                            Paterno: </label>
                                                    </div>
                                                    <div class="col-md-3 mb-3">
                                                        <input type="text"
                                                            class="form-control form-remanso letras-only"
                                                            name="apellPRegVta" id="apellPRegVta" required>
                                                    </div>
                                                    <div class="col-md-3 mb-3">
                                                        <label for="inputText" class="col-form-label">(*) Apellido
                                                            Materno: </label>
                                                    ...
                                                    <div class="col-md-3 mb-3">
                                                        <input type="text"
                                                            class="form-control form-remanso letras-only"
                                                            name="apellMRegVta" id="apellMRegVta" required>
                                                    </div>
                                                    <div class="col-md-3 mb-3" id="labelCodProspecto"
                                                        style="display: none;">
                                                        <label for="inputText" class="col-form-label">(*) Codigo
                                                            Prospecto: </label>
                                                    </div>
                                                    <div class="col-md-3 mb-3" id="divCodProspecto" style="">
                                                        <input type="text" disabled
                                                            class="form-control form-remanso letras-only"
                                                            name="inputCodProspecto" id="inputCodProspecto">
                                                    </div>
                                                </div>
                                            </div>
                                            <div id="razonSoc" style="display: none;">
                                                <div class="row">
                                                    <div class="col-md-3 mb-3">
                                                        <label for="inputText" class="col-form-label">Razón
                                                            social:</label>
                                                    </div>
                                                    <div class="col-md-9 mb-3">
                                                        <input type="text"
                                                            class="form-control form-remanso align-right"
                                                            name="razonSocRegVta" id="razonSocRegVta">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-9 mb-3">
                                                    <input type="text" class="form-control form-remanso"
                                                        name="direccRegVta" id="direccRegVta" required>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-3 mb-3">
                                                    <label for="inputText" class="col-form-label">Dirección de
                                                        referencia:</label>
                                                </div>
                                                <div class="col-md-9 mb-3">
                                                    <input type="text" class="form-control form-remanso"
                                                        name="direccRefRegVta" id="direccRefRegVta">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-3 mb-3">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <select name="paisRegVta" id="paisRegVta"
                                                        class="form-select form-remanso">
                                                    </select>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label for="inputText" class="col-form-label">(*) Departamento:
                                                    </label>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <select name="dptoRegVta" id="dptoRegVta"
                                                        class="form-select form-remanso">
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-3 mb-3">
                                                    <label for="inputText" class="col-form-label">(*) Provincia:
                                                    </label>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <select name="provRegVta" id="provRegVta"
                                                        class="form-select form-remanso">
                                                    </select>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label for="inputText" class="col-form-label">(*) Distrito:
                                                    </label>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <select name="dttoRegVta" id="dttoRegVta"
                                                        class="form-select form-remanso">
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-3 mb-3">
                                                    <label for="inputText" class="col-form-label">(*) Teléfono
                                                        1:</label>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <input type="text"
                                                        class="form-control form-remanso align-right"
                                                        name="telf1RegVta" id="telf1RegVta" required>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <input type="text"
                                                        class="form-control form-remanso align-right"
                                                        name="telf2RegVta" id="telf2RegVta">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-3 mb-3">
                                                ...
                                                <div class="col-md-9 mb-3">
                                                    <input type="text" class="form-control form-remanso"
                                                        name="correoRegVta" id="correoRegVta" required>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-3 mb-2">
                                                    <label for="inputText" class="col-form-label">(*) Estado
                                                        civil:</label>
                                                </div>
                                                <div class="col-md-2 mb-2">
                                                    <select name="edoCivilRegVta" id="edoCivilRegVta"
                                                        class="form-select form-remanso" required>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-2 mb-2">
                                                    <select name="sexoRegVta" id="sexoRegVta"
                                                        class="form-select form-remanso" required>
                                                    </select>
                                                </div>
                                                <div class="col-md-2 mb-2">
                                                    <label for="inputText" class="col-form-label">(*) Fch Nacimiento:
                                                    </label>
                                                </div>
                                                <div class="col-md-2 mb-2">
                                                    <input type="text"
                                                        class="form-control form-remanso align-right"
                                                        name="fchNacRegVta" id="fchNacRegVta" required>
                                                </div>
                                            </div>

                                            <div class="row">
                                                <div class="col-md-3 mb-3">
                                                    <label for="inputText" class="col-form-label" hidden>Comprobante
                                                        de venta:</label>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <select name="compVtaRegVta" id="compVtaRegVta"
                                                        class="form-select form-remanso" hidden>
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <input type="text"
                                                        class="form-control form-remanso align-right"
                                                        name="rucCompVtaRegVta" id="rucCompVtaRegVta" hidden disabled>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-3 mb-3">
                                                    <label for="inputText" class="col-form-label" hidden>Razon
                                                        social:</label>
                                                </div>
                                                <div class="col-md-9 mb-3">
                                                    <input type="text" class="form-control form-remanso"
                                                        name="razSocCompVtaRegVta" id="razSocCompVtaRegVta" hidden
                                                        disabled>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#collapse2do"
                                            aria-expanded="false" aria-controls="collapse2do">
                                            <h4>2do Titular</h4>
                                        </button>
                                    </h2>
                                    <div id="collapse2do" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <br>
                                            <div class="row">
                                                <div class="col-md-3 mb-3">
                                                    <label for="inputText" class="col-form-label">(*) Tipo de
                                                        Documento: </label>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <select name="tipoDoc2doRegVta" id="tipoDoc2doRegVta"
                                                        class="form-select form-remanso">
                                                    </select>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label for="inputText" class="col-form-label">(*) Núm. de
                                                        Documento: </label>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <input type="text"
                                                        class="form-control form-remanso align-right"
                                                        name="numDoc2doRegVta" id="numDoc2doRegVta">
                                                </div>
                                            </div>
                                            <div id="nombre">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 mb-3">
                                                        <input type="text"
                                                            class="form-control form-remanso letras-only"
                                                            name="nombres2doRegVta" id="nombres2doRegVta">
                                                    </div>
                                                    <div class="col-md-3 mb-3">
                                                        <label for="inputText" class="col-form-label">(*) Apellido
                                                            Paterno: </label>
                                                    ...
                                                    <div class="col-md-3 mb-3">
                                                        <input type="text"
                                                            class="form-control form-remanso letras-only"
                                                            name="apellP2doRegVta" id="apellP2doRegVta">
                                                    </div>
                                                    <div class="col-md-3 mb-3">
                                                        <label for="inputText" class="col-form-label">(*) Apellido
                                                            Materno: </label>
                                                    ...
                                                    <div class="col-md-3 mb-3">
                                                        <input type="text"
                                                            class="form-control form-remanso letras-only"
                                                            name="apellM2doRegVta" id="apellM2doRegVta" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div id="razonSoc" style="display: none;">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9 mb-3">
                                                        <input type="text"
                                                            class="form-control form-remanso align-right"
                                                            name="razonSoc2doRegVta" id="razonSoc2doRegVta">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-9 mb-3">
                                                    <input type="text" class="form-control form-remanso"
                                                        name="direcc2doRegVta" id="direcc2doRegVta" required>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-3 mb-3">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <select name="pais2doRegVta" id="pais2doRegVta"
                                                        class="form-select form-remanso" required>
                                                    </select>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <select name="dpto2doRegVta" id="dpto2doRegVta"
                                                        class="form-select form-remanso" required>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <select name="prov2doRegVta" id="prov2doRegVta"
                                                        class="form-select form-remanso" required>
                                                    </select>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <select name="dtto2doRegVta" id="dtto2doRegVta"
                                                        class="form-select form-remanso" required>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <input type="text"
                                                        class="form-control form-remanso align-right"
                                                        name="telf12doRegVta" id="telf12doRegVta" required>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label for="inputText" class="col-form-label">Teléfono 2: </label>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <input type="text"
                                                        class="form-control form-remanso align-right"
                                                        name="telf22doRegVta" id="telf22doRegVta">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-3 mb-3">
                                                ...
                                                <div class="col-md-9 mb-3">
                                                    <input type="text" class="form-control form-remanso"
                                                        name="correo2doRegVta" id="correo2doRegVta" required>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-3 mb-2">
                                                ...
                                                <div class="col-md-3 mb-2">
                                                    <select name="edoCivil2doRegVta" id="edoCivil2doRegVta"
                                                        class="form-select form-remanso" required>
                                                    </select>
                                                </div>
                                                <div class="col-md-3 mb-2">
                                                ...
                                                <div class="col-md-3 mb-2">
                                                    <input type="text"
                                                        class="form-control form-remanso align-right"
                                                        name="fchNac2doRegVta" id="fchNac2doRegVta" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="accordion-item" id="acordeonAval">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#collapseAval"
                                            aria-expanded="false" aria-controls="collapseAval">
                                            <h4>Aval</h4>
                                        </button>
                                    </h2>
                                    <div id="collapseAval" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <br>
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <select name="tipoDocAval" id="tipoDocAval"
                                                        class="form-select form-remanso">
                                                    </select>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                            ...
                                            <div id="nombre">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 mb-3">
                                                        <input type="text"
                                                            class="form-control form-remanso letras-only"
                                                            name="nombresAval" id="nombresAval">
                                                    </div>
                                                    <div class="col-md-3 mb-3">
                                                        <label for="inputText" class="col-form-label">Apellido
                                                            Paterno: </label>
                                            ...
                                            <div id="razonSoc" style="display: none;">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9 mb-3">
                                                        <input type="text"
                                                            class="form-control form-remanso align-right"
                                                            name="razonSocAval" id="razonSocAval">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <select name="paisAval" id="paisAval"
                                                        class="form-select form-remanso">
                                                    </select>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <select name="dptoAval" id="dptoAval"
                                                        class="form-select form-remanso">
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <select name="provAval" id="provAval"
                                                        class="form-select form-remanso">
                                                    </select>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <select name="dttoAval" id="dttoAval"
                                                        class="form-select form-remanso">
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 mb-2">
                                                    <select name="edoCivilAval" id="edoCivilAval"
                                                        class="form-select form-remanso" required>
                                                    </select>
                                                </div>
                                                <div class="col-md-3 mb-2">
                                                ...
                                                <div class="col-md-3 mb-2">
                                                    <input type="text"
                                                        class="form-control form-remanso align-right"
                                                        name="fchNacAval" id="fchNacAval" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#collapseBeneficiario"
                                            aria-expanded="false" aria-controls="collapseBeneficiario">
                                            <h4>Beneficiarios</h4>
                                        </button>
                                    </h2>
                                    <div id="collapseBeneficiario" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <br>
                                            <div class="row">
                                                <div class="col-md-3 offset-md-9">
                                                    <div class="form-group form-remanso">
                                                        <h5><button class="btn btn-danger BtnverdeRemanso form-remanso"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#ModalBeneficiarios"
                                                                style="width: -webkit-fill-available;" type="button"
                                                                id="abreModalBenef">Añadir Beneficiario</button></h5>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="table-responsive">
                                                <table class="table table-striped" id="tablaBeneficiarios"
                                                    ...
                                                    <thead style="background-color: #081d31; color: white;">
                                                        <tr>
                                                            <th style="text-align: center;" width="15%">Tipo
                                                                Documento</th>
                                                            <th style="text-align: center;" width="30%">
                                                                Beneficiario</th>
                                                            <th style="text-align: center;" width="15%">Fecha de
                                                                nacimiento</th>
                                                            <th style="text-align: center;" width="10%">Parentesco
                                                            </th>
                                                            <th style="text-align: center;" width="5%">Sexo</th>
                                                            <th style="text-align: center;" width="10%">E. Civil
                                                            </th>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#collapseServicios"
                                            aria-expanded="false" aria-controls="collapseServicios">
                                            <h4>Registro de Servicios</h4>
                                        </button>
                                    </h2>
                                    <div id="collapseServicios" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <br>
                                            <div class="row">
                                                <div class="col-md-1 mb-3">
                                                    <label for="inputText" class="col-form-label">Tipo programa:
                                                    </label>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                ...
                                                <div class="col-md-1 mb-3">
                                                    <label for="inputText" class="col-form-label">Tipo Servicio:
                                                    </label>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <select name="subtipoServ" id="subtipoServ"
                                                        class="form-select form-remanso">
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <select name="camposanto" id="camposanto"
                                                        class="form-select form-remanso">
                                                    </select>
                                                </div>
                                                <div class="col-md-1 mb-3">
                                                    <label for="inputText" class="col-form-label">Tipo Plataforma:
                                                    </label>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <select name="tipoPlat" id="tipoPlat"
                                                        class="form-select form-remanso">
                                                    </select>
                                                </div>
                                                <div class="col-md-1 mb-3">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <select name="nombrePlat" id="nombrePlat"
                                                        class="form-select form-remanso">
                                                    </select>
                                                </div>
                                                <div class="col-md-1 mb-3">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <select name="nivelRegVnta" id="nivelRegVnta"
                                                        class="form-select form-remanso" disabled>
                                                    </select>
                                                </div>

                                                <div class="col-md-1 mb-3">
                                                    <label for="inputText" class="col-form-label">Tipo espacio:
                                                    </label>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <select name="tipoEspacio" id="tipoEspacio"
                                                        class="form-control form-remanso" disabled>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-2 mb-3">
                                                    <label for="inputText" class="col-form-label">Contrato (Base):
                                                    </label>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <input type="text" class="form-control form-remanso"
                                                        name="cttoBase" id="cttoBase">
                                                </div>
                                                <div class="col-md-1 mb-1">
                                                    <input type="text" class="form-control form-remanso"
                                                        name="numServBase" id="numServBase">
                                                </div>
                                                <div class="col-md-2 offset-md-1 mb-3">
                                                    <label for="inputText" class="col-form-label"><b>Num.
                                                            Operación:</b></label>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <input type="text" class="form-control form-remanso"
                                                        name="numOpeRegVta" id="numOpeRegVta">
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="row">
                                                <div class="col-md-3 offset-md-9">
                                                    <div class="form-group form-remanso">
                                                        <h5><button class="btn btn-danger BtnverdeRemanso form-remanso"
                                                                ...
                                                                id="btnAddServicio" type="button"
                                                                style="width: -webkit-fill-available;">Añadir
                                                                servicio</button></h5>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="table-responsive">
                                                        <table class="table table-striped " id="tablaServiciosAdded"
                                                            style="width:100%">
                                                            <thead style="background-color: #081d31;; color: white;">
                                                                <tr>
                                                                    <th style="text-align: center;" width="30%">
                                                                    ...
                                                                    <th style="text-align: center;" width="10%">
                                                                        Precio Total</th>
                                                                    <th style="text-align: center;" width="10%">CUI
                                                                    </th>
                                                                    <th style="text-align: center;" width="10%">
                                                                        Saldo</th>
                                                                    <th style="text-align: center;" width="10%">
                                                            ...
                                                            <tfoot>
                                                                <tr>
                                                                    ...
                                                                    <td id="sumTotal" style="text-align: right;">0.00
                                                                    </td>
                                                                    <td id="sumCuoi" style="text-align: right;">0.00
                                                                    </td>
                                                                    <td id="sumSaldo" style="text-align: right;">0.00
                                                                    </td>
                                                                    <td></td>
                                                                </tr>
                                                            </tfoot>
                                            ...
                                            <div class="row">
                                                <div class="col-md-2 mb-3">
                                                    <label for="inputText" class="col-form-label">Precio Total:
                                                    </label>
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    <input type="text"
                                                        class="form-control form-remanso align-right" name="impTotal"
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <input type="text"
                                                        class="form-control form-remanso align-right" name="impCuoi"
                                                        id="impCuoi" disabled>
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <input type="text"
                                                        class="form-control form-remanso align-right" name="impSaldo"
                                                        id="impSaldo" disabled>
                                                    <input type="hidden" name="impDscto" id="impDscto" value=0>
                                                    <input type="hidden" name="pordescuento" id="pordescuento"
                                                        value="0">
                                                    <input type="hidden" name="impDsctoAdicional"
                                                        id="impDsctoAdicional">
                                                    ...
                                                    <input type="hidden" name="tieneDS" id="tieneDS"
                                                        value='NO'>
                                                    <input type="hidden" name="esCompartido" id="esCompartido"
                                                        value = 'NO'>
                                                    <input type="hidden" name="codConsejeroVend"
                                                        id="codConsejeroVend">
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    <label for="inputText" class="col-form-label">Cuotas servicio:
                                                    </label>
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    <select name="codCuotaServ" id="codCuotaServ"
                                                        class="form-select form-remanso">
                                                    </select>
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    <label for="inputText" class="col-form-label">Tasa de interés (%):
                                                    </label>
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    <select name="codTasa" id="codTasa"
                                                        class="form-select form-remanso">
                                                    </select>
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    <label for="inputText" class="col-form-label">Inicio Cuota
                                                        interés:
                                                    </label>
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    <input type="number" min="0" max="83"
                                                        class="form-control form-remanso align-right" name="cuoIniInt"
                                                        id="cuoIniInt" disabled>
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    <label for="inputText" class="col-form-label">Fch. 1er
                                                        vencimiento: </label>
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    <input type="text"
                                                        class="form-control form-remanso align-right"
                                                        name="fch1erVcto" id="fch1erVcto">
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <input type="text" disabled
                                                        class="form-control form-remanso align-right" name="impFoma"
                                                        id="impFoma">
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    <label for="inputText" class="col-form-label">Cuotas FOMA:
                                                    </label>
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    <select name="codCuotaFoma" id="codCuotaFoma" disabled
                                                        class="form-control form-remanso align-right">
                                                        <option value="068" selected>1</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    <label for="inputText" class="col-form-label">Importe Cuota:
                                                    </label><br>
                                                    <span style="font-size:0.7em">* cuota referencial</span>
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    <input type="text"
                                                        class="form-control form-remanso align-right" name="imp_cuota"
                                                        id="imp_cuota" disabled>
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    <label for="inputText" class="col-form-label">Imp. separación:
                                                    </label><br>
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    <input type="text"
                                                        class="form-control form-remanso align-right"
                                                        name="imp_separacion" id="imp_separacion" disabled>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-2 mb-3">
                                                    <label for="inputText" class="col-form-label">Observaciones:
                                                    </label>
                                                </div>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#collapseDocumentos"
                                    ...
                                    <div id="collapseDocumentos" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <div class="row">
                                                <div class="col-md-5 offset-7">
                                                    <div style="border: solid 1px">
                                                        &nbsp;&nbsp; Info: <span class="bi bi-check"
                                                            style="color: green; font-size:2em;"></span> Ya tiene un
                                                        documento guardado.
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-2 mb-3">
                                                    <label for="inputText" class="col-form-label"> DNI Titular:
                                                    </label>
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <div class="custom-file">
                                                        {{-- <input class="form-control form-remanso form-control-sm"
                                                            id="DniAdj1" type="file"> --}}


                                                        <div class="input-group">
                                                            <input type="file" class="form-control form-control-sm"
                                                                name="DniAdj1" id="DniAdj1"
                                                                placeholder="Ingrese apellido materno"
                                                                accept="application/pdf">

                                                            <span class="input-group-text" id="DNI_ADJN_1"></span>

                                                            <button type="button"
                                                                class="btn btn-outline-secondary btn-visor-doc"
                                                                id="btn_DNI_ADJN_1" data-bs-toggle="modal"
                                                                data-bs-target="#VisorDocumento" data-id_documento>
                                                                <i class="fa fa-eye"></i>
                                                            </button>
                                                        </div>
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <label for="inputText" class="col-form-label">DNI Alterno:
                                                    </label>
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    {{-- <input class="form-control form-remanso form-control-sm"
                                                        id="Dni2Adj1" type="file"> --}}

                                                    <div class="input-group">
                                                        <input type="file" class="form-control form-control-sm"
                                                            name="Dni2Adj1" id="Dni2Adj1"
                                                            placeholder="Ingrese apellido materno"
                                                            accept="application/pdf">

                                                        <span class="input-group-text" id="DNI_ADJN_2_1"></span>

                                                        <button type="button"
                                                            class="btn btn-outline-secondary btn-visor-doc"
                                                            id="btn_DNI_ADJN_2_1" data-bs-toggle="modal"
                                                            data-bs-target="#VisorDocumento" data-id_documento>
                                                            <i class="fa fa-eye"></i>
                                                        </button>
                                                    </div>
                                                ...
                                                {{-- <div class="col-md-2 mb-3">
                                                    <label for="inputText" class="col-form-label">DNI Alterno reverso:
                                                    </label>
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="file" class="form-control form-control-sm"
                                                            name="Dni2Adj2" id="Dni2Adj2"
                                                            placeholder="Ingrese apellido materno"
                                                            accept="application/pdf">

                                                        <span class="input-group-text" id="DNI_ADJN_2_2"></span>

                                                        <button type="button"
                                                            class="btn btn-outline-secondary btn-visor-doc"
                                                            id="btn_DNI_ADJN_2_2" data-bs-toggle="modal"
                                                            data-bs-target="#VisorDocumento" data-id_documento>
                                                            <i class="fa fa-eye"></i>
                                                        </button>
                                                    </div>
                                                ...
                                                <div class="col-md-2 mb-3" id="tituloDniAval1">
                                                    <label for="inputText" class="col-form-label">DNI Aval anverso:
                                                    </label>
                                                </div>
                                                <div class="col-md-4 mb-3" id="inputDniAval1">
                                                    {{-- <input class="form-control form-remanso form-control-sm"
                                                        id="DniAvalAdj1" type="file"> --}}

                                                    <div class="input-group">
                                                        <input type="file" class="form-control form-control-sm"
                                                            name="DniAvalAdj1" id="DniAvalAdj1"
                                                            placeholder="Ingrese apellido materno"
                                                            accept="application/pdf">

                                                        <span class="input-group-text" id="DNI_AVAL_1"></span>

                                                        <button type="button"
                                                            class="btn btn-outline-secondary btn-visor-doc"
                                                            id="btn_DNI_AVAL_1" data-bs-toggle="modal"
                                                            data-bs-target="#VisorDocumento" data-id_documento>
                                                            <i class="fa fa-eye"></i>
                                                        </button>
                                                    </div>
                                                ...
                                                <div class="col-md-2 mb-3" id="tituloDniAval2">
                                                    <label for="inputText" class="col-form-label">DNI Aval reverso:
                                                    </label>
                                                </div>
                                                <div class="col-md-4 mb-3" id="inputDniAval2">
                                                    {{-- <input class="form-control form-remanso form-control-sm"
                                                        id="DniAvalAdj2" type="file"> --}}

                                                    <div class="input-group">
                                                        <input type="file" class="form-control form-control-sm"
                                                            name="DniAvalAdj2" id="DniAvalAdj2"
                                                            placeholder="Ingrese apellido materno"
                                                            accept="application/pdf">

                                                        <span class="input-group-text" id="DNI_AVAL_2"></span>

                                                        <button type="button"
                                                            class="btn btn-outline-secondary btn-visor-doc"
                                                            id="btn_DNI_AVAL_2" data-bs-toggle="modal"
                                                            data-bs-target="#VisorDocumento" data-id_documento>
                                                            <i class="fa fa-eye"></i>
                                                        </button>
                                                    </div>
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <label for="inputText" class="col-form-label">Hoja Facturación:
                                                    </label>
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    {{-- <input class="form-control form-remanso form-control-sm"
                                                        id="recServAdj" type="file"> --}}

                                                    <div class="input-group">
                                                        <input type="file" class="form-control form-control-sm"
                                                            name="recServAdj" id="recServAdj"
                                                            placeholder="Ingrese apellido materno"
                                                            accept="application/pdf">

                                                        <span class="input-group-text" id="RECIBO_SERV"></span>

                                                        <button type="button"
                                                            class="btn btn-outline-secondary btn-visor-doc"
                                                            id="btn_RECIBO_SERV" data-bs-toggle="modal"
                                                            data-bs-target="#VisorDocumento" data-id_documento>
                                                            <i class="fa fa-eye"></i>
                                                        </button>
                                                    </div>
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <label for="inputText" class="col-form-label">Comprobante de
                                                        Pago:
                                                    </label>
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    {{-- <input class="form-control form-remanso form-control-sm"
                                                        id="comprobanteAdj" type="file"> --}}

                                                    <div class="input-group">
                                                        <input type="file" class="form-control form-control-sm"
                                                            name="comprobanteAdj" id="comprobanteAdj"
                                                            placeholder="Ingrese apellido materno"
                                                            accept="application/pdf">
                                                        ...
                                                        <button type="button"
                                                            class="btn btn-outline-secondary btn-visor-doc"
                                                            id="btn_COMPROBANTE" data-bs-toggle="modal"
                                                            data-bs-target="#VisorDocumento" data-id_documento>
                                                            <i class="fa fa-eye"></i>
                                                        </button>
                                                    </div>
                                                ...
                                                <div class="col-md-2 mb-3" id="tituloRecSep">
                                                    <label for="inputText" class="col-form-label">Recibo
                                                        Provisional:
                                                    </label>
                                                </div>
                                                <div class="col-md-4 mb-3" id="inputRecSep">
                                                    {{-- <input class="form-control form-remanso form-control-sm"
                                                        id="RecSepAdj" type="file"> --}}

                                                    <div class="input-group">
                                                        <input type="file" class="form-control form-control-sm"
                                                            name="RecSepAdj" id="RecSepAdj"
                                                            placeholder="Ingrese apellido materno"
                                                            accept="application/pdf">

                                                        <span class="input-group-text" id="RECIBO_SEP"></span>

                                                        <button type="button"
                                                            class="btn btn-outline-secondary btn-visor-doc"
                                                            id="btn_RECIBO_SEP" data-bs-toggle="modal"
                                                            data-bs-target="#VisorDocumento" data-id_documento>
                                                            <i class="fa fa-eye"></i>
                                                        </button>
                                                    </div>
                                                ...
                                                <div class="col-md-2 mb-3" id="tituloDniFall">
                                                    <label for="inputText" class="col-form-label">DNI Fallecido:
                                                    </label>
                                                </div>
                                                <div class="col-md-4 mb-3" id="inputDniFall">
                                                    <div class="custom-file">
                                                        {{-- <input class="form-control form-remanso form-control-sm"
                                                            id="DniAdj2" type="file"> --}}

                                                        <div class="input-group">
                                                            <input type="file"
                                                                class="form-control form-control-sm" name="DniFall"
                                                                id="DniFall" accept="application/pdf">

                                                            <span class="input-group-text" id="DNI_FALL"></span>

                                                            <button type="button"
                                                                class="btn btn-outline-secondary btn-visor-doc"
                                                                id="btn_DNI_FALL" data-bs-toggle="modal"
                                                                data-bs-target="#VisorDocumento" data-id_documento>
                                                                <i class="fa fa-eye"></i>
                                                            </button>
                                                        </div>
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <label for="inputText" class="col-form-label">Declaracion
                                                        Jurada:
                                                    </label>
                                                </div>
                                                <div class="col-md-4 mb-3" id="inputRecSep">
                                                    {{-- <input class="form-control form-remanso form-control-sm"
                                                        id="declaracionFile" type="file"> --}}

                                                    <div class="input-group">
                                                        <input type="file" class="form-control form-control-sm"
                                                            name="declaracionFile" id="declaracionFile"
                                                            placeholder="Ingrese apellido materno"
                                                            accept="application/pdf">

                                                        <span class="input-group-text" id="DECLARACION_J"></span>

                                                        <button type="button"
                                                            class="btn btn-outline-secondary btn-visor-doc"
                                                            id="btn_DECLARACION_J" data-bs-toggle="modal"
                                                            data-bs-target="#VisorDocumento" data-id_documento>
                                                            <i class="fa fa-eye"></i>
                                                        </button>
                                                    </div>
                                                ...
                                                {{-- <div class="col-md-2 mb-3">
                                                    <label for="inputText" class="col-form-label">Firma:
                                                    </label>
                                                </div>
                                                <div class="col-md-4 mb-3" id="inputRecSep">
                                                    <input class="form-control form-remanso form-control-sm"
                                                        id="firmaFile" type="file">
                                                </div> --}}

                                                <div class="col-md-2 mb-3">
                                                    <label for="inputText" class="col-form-label">Firma Titular:
                                                    </label>
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    {{-- <input class="form-control form-remanso form-control-sm"
                                                        id="firmaTitular" type="file"> --}}

                                                    <div class="input-group">
                                                        <input type="file" class="form-control form-control-sm"
                                                            name="firmaTitular" id="firmaTitular"
                                                            placeholder="Ingrese apellido materno">

                                                        <span class="input-group-text" id="FIRMA_TTLR"></span>

                                                        <button type="button"
                                                            class="btn btn-outline-secondary btn-visor-doc"
                                                            id="btn_FIRMA_TTLR" data-bs-toggle="modal"
                                                            data-bs-target="#VisorDocumento" data-id_documento>
                                                            <i class="fa fa-eye"></i>
                                                        </button>
                                                    </div>
                                                ...
                                                <div class="col-md-4 mb-3" id="inputRecSep">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="file" class="form-control form-control-sm"
                                                            name="declaracionFile_2" id="declaracionFile_2"
                                                            placeholder="Ingrese apellido materno"
                                                            accept="application/pdf">

                                                        <span class="input-group-text" id="DECLARACION_J_2"></span>

                                                        <button type="button"
                                                            class="btn btn-outline-secondary btn-visor-doc"
                                                            id="btn_DECLARACION_J_2" data-bs-toggle="modal"
                                                            data-bs-target="#VisorDocumento" data-id_documento>
                                                            <i class="fa fa-eye"></i>
                                                        </button>
                                                    </div>
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <label for="inputText" class="col-form-label">Firma 2do Titular:
                                                    </label>
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    {{-- <input class="form-control form-remanso form-control-sm"
                                                    ...
                                                    <div class="input-group">
                                                        <input type="file" class="form-control form-control-sm"
                                                            name="firmaTitular_2" id="firmaTitular_2"
                                                            placeholder="Ingrese apellido materno">

                                                        <span class="input-group-text" id="FIRMA_TTLR_2"></span>

                                                        <button type="button"
                                                            class="btn btn-outline-secondary btn-visor-doc"
                                                            id="btn_FIRMA_TTLR_2" data-bs-toggle="modal"
                                                            data-bs-target="#VisorDocumento" data-id_documento>
                                                            <i class="fa fa-eye"></i>
                                                        </button>
                                                    </div>
                                                ...
                                                <div class="col-md-2 mb-3" style="display: none"
                                                    id="tituloActaDefAdj">
                                                    <label for="inputText" class="col-form-label">Acta de defunción:
                                                    </label>
                                                </div>
                                                <div class="col-md-4 mb-3" style="display: none"
                                                    id="inputActaDefAdj">
                                                    {{-- <input class="form-control form-remanso form-control-sm"
													id="ActaDefAdj" type="file"> --}}

                                                    <div class="input-group">
                                                        <input type="file" class="form-control form-control-sm"
                                                            name="acta_def_1_doc_drive" id="acta_def_1_doc_drive"
                                                            placeholder="Ingrese apellido materno"
                                                            accept="application/pdf">

                                                        <span class="input-group-text" id="ACTA_BNF1"></span>

                                                        <button type="button"
                                                            class="btn btn-outline-secondary btn-visor-doc"
                                                            id="btn_ACTA_BNF1" data-toggle="modal"
                                                            data-target="#VisorDocumento" data-id_documento>
                                                            <i class="fa fa-eye"></i>
                                                        </button>
                                                    </div>
                                                ...
                                                <div class="col-md-2 mb-3" style="display: none"
                                                    id="tituloCertDefAAdj">
                                                    <label for="inputText" class="col-form-label">Certif. de
                                                        defunción
                                                        A: </label>
                                                </div>
                                                <div class="col-md-4 mb-3" style="display: none"
                                                    id="inputCertDefAAdj">
                                                    <input class="form-control form-remanso form-control-sm"
                                                        id="CertDefAAdj" type="file">
                                                </div>
                                                <div class="col-md-2 mb-3" style="display: none"
                                                    id="tituloCertDefBAdj">
                                                    <label for="inputText" class="col-form-label">Certif. de
                                                        defunción
                                                        B: </label>
                                                </div>
                                                <div class="col-md-4 mb-3" style="display: none"
                                                    id="inputCertDefBAdj">
                                                    <input class="form-control form-remanso form-control-sm"
                                                        id="CertDefBAdj" type="file">
                                                </div>
                                                <div class="col-md-2 mb-3" style="display: none"
                                                    id="tituloNecroAdj">
                                                    <label for="inputText" class="col-form-label">Necropsia:
                                                    </label>
                                                </div>
                                                <div class="col-md-4 mb-3" style="display: none"
                                                    id="inputNecroAdj">
                                                    <input class="form-control form-remanso form-control-sm"
                                                        id="NecroAdj" type="file">
                                                </div>
                                                <div class="col-md-2 mb-3" style="display: none"
                                                    id="tituloConstInhuAdj">
                                                    <label for="inputText" class="col-form-label">Hoja Lapida NI:
                                                    </label>
                                                </div>
                                                <div class="col-md-4 mb-3" style="display: none"
                                                    id="inputConstInhuAdj">
                                                    <input class="form-control form-remanso form-control-sm"
                                                        id="ConstInhuAdj" type="file">
                                                </div>
                                                <div class="col-md-2 mb-3" style="display: none"
                                                    id="tituloAutSanitAdj">
                                                    <label for="inputText" class="col-form-label">Autorización
                                                        sanitaria: </label>
                                                </div>
                                                <div class="col-md-4 mb-3" style="display: none"
                                                    id="inputAutSanitAdj">
                                                    <input class="form-control form-remanso form-control-sm"
                                                        id="AutSanitAdj" type="file">
                                                </div>
                                                <div class="col-md-2 mb-3" style="display: none"
                                                    id="tituloOtrosAdj">
                            ...
                            <div class="row">
                                <div class="col-md-3 offset-md-4 mb-3">
                                    <button type="button" class="btn btn-danger form-remanso BtnverdeRemanso"
                                        id="registrarVenta" style="width: -webkit-fill-available;">Guardar</button>
                                </div>
                            </div>
                            <br>
                        </div>
                        ...
                        <div class="row">
                            <div class="table-responsive">
                                <table class="table table-striped" id="tablaServicios" style="width:100%">
                                    <thead style="background-color: #689c44; color: white;">
                                        <tr>
                                            <th style="text-align: center;" width="5%">Código</th>
                                            <th style="text-align: center;" width="45%">Descripción de Servicio
                                            </th>
        ...
        <div class="modal fade" id="ModalBeneficiarios" tabindex="-1" aria-labelledby="ModalBeneficiariosLabel"
            ...
            <div class="modal-dialog  modal-dialog-centered modal-lg modal-dialog-scrollable">
                <div class="modal-content form-remanso">
                    <div class="modal-header">
                        <h1 class="modal-title tarjeta-vaca-foco fs-5" id="ModalBeneficiariosLabel">Añadir
                            Beneficiarios
                        </h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                <select name="tipoDocAddBenef" id="tipoDocAddBenef"
                                    class="form-select form-remanso">
                                </select>
                            </div>
                            <div class="col-md-3 mb-3">
                            ...
                            <div class="col-md-3 mb-3">
                                <input type="text" class="form-control form-remanso align-right"
                                    name="numDocAddBenef" id="numDocAddBenef">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3 mb-3">
                            ...
                            <div class="col-md-9 mb-3">
                                <input type="text" class="form-control form-remanso letras-only"
                                    name="nombresAddBenef" id="nombresAddBenef">
                            </div>
                            <div class="col-md-3 mb-3">
                            ...
                            <div class="col-md-3 mb-3">
                                <input type="text" class="form-control form-remanso letras-only"
                                    name="apellPAddBenef" id="apellPAddBenef">
                            </div>
                            <div class="col-md-3 mb-3">
                            ...
                            <div class="col-md-3 mb-3">
                                <input type="text" class="form-control form-remanso letras-only"
                                    name="apellMAddBenef" id="apellMAddBenef">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="inputText" class="col-form-label">Fecha de nacimiento: </label>
                            </div>
                            <div class="col-md-3 mb-3">
                                <input type="text" class="form-control form-remanso" name="fchNacAddBenef"
                                    id="fchNacAddBenef" placeholder="seleccione..">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="inputText" class="col-form-label">Parentesco: </label>
                            </div>
                            <div class="col-md-3 mb-3">
                                <select name="parentescoAddBenef" id="parentescoAddBenef"
                                    class="form-select form-remanso">
                                </select>
                            </div>
                            <div class="col-md-3 mb-3">
                            ...
                            <div class="col-md-3 mb-3">
                                <select name="edoCivilAddBenef" id="edoCivilAddBenef"
                                    class="form-select form-remanso">
                                </select>
                            </div>
                            <div class="col-md-3 mb-3">
                            ...
                            <div class="col-md-3 mb-3">
                                <input type="checkbox" data-toggle="toggle" id="flg_fallecido" data-onlabel="SI"
                                    data-offlabel = "NO" data-onstyle ="success">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" id="agregaBeneficiario"
                            class="btn btn-primary BtnAzulORemanso form-remanso"
                            data-bs-dismiss="modal">Aceptar</button>
                        <button type="button" id="btnUpdBeneficiario"
                            class="btn btn-primary BtnAzulORemanso form-remanso" data-bs-dismiss="modal"
                            hidden>Modificar</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    @include('components.modals.VisualizarDocumentosModal')
...
<script src="{{ asset('js/DocumentosDrive.js') }}"></script>
<script type="text/javascript">
    ...
    botonNece.addEventListener("change", function() {
        ...
        if (this.checked == true) {
            ...
            document.getElementById('tituloDniFall').style.display = "block";
            document.getElementById('inputDniFall').style.display = "block";
            ...
            document.getElementById('tituloDniFall').style.display = "none";
            document.getElementById('inputDniFall').style.display = "none";
        ...
        var flg_ni = (this.checked) ? "SI" : "NO";
        var flg_nf = (this.checked) ? "NO" : "SI";
        ...
        $.ajax({
            ...
            success: function(respuesta) {
                var optionsTP = document.querySelectorAll('#tipoPrograma option');
                optionsTP.forEach(o => o.remove());
                $("#tipoPrograma").append(
                    '<option value="" selected disabled>SELECCIONE...</option>');
                respuesta['response'].forEach(function(word) {
                    seleccion = '';
                    $("#tipoPrograma").append('<option value="' + word['codvar'] + '" ' +
                        seleccion + ' compar="' + word['desvar3'] + '" integral="' +
                        word['desvar4'] + '" validaEsp="' + word['desvar2'] + '"  >' +
                        word['desvar1'] + '</option>');
                });
            }, //success
            error(e) {
    ...
    numDocProsInput.addEventListener("input", function(event) {
        ...
        if (tam < 12) {
            ...
            if (inputValue.length != tam) {
                numDocProsInput.setCustomValidity("Debe ingresar " + tam +
                    " dígitos"); // Mostrar mensaje de error
    ...
    numDocProsInput.addEventListener("blur", function(event) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: {
                'tipoDoc': document.getElementById("tipoDocRegVta").value,
                'dscDocumento': document.getElementById("numDocRegVta").value
            },
            success: function(respuesta) {
                //console.log('@php echo(session('cod_trabajador')) @endphp');
                if (respuesta['response']['cod_prospecto'] != null) {
                    if (respuesta['response']['cod_consejero'] == '@php echo(session('cod_trabajador')) @endphp' || botonNece
                        .checked == true) {
                        Swal.fire({
                            title: 'Advertencia!',
                            text: 'Ya existe un prospecto con número de documento ' +
                                respuesta['response']['dsc_documento'] +
                            ...
                            if (result.isConfirmed) {
                                document.getElementById("nombresRegVta").value = respuesta[
                                    'response']['dsc_nombre'];
                                document.getElementById("apellPRegVta").value = respuesta[
                                    'response']['dsc_apellido_paterno'];
                                document.getElementById("apellMRegVta").value = respuesta[
                                    'response']['dsc_apellido_materno'];
                                document.getElementById("inputCodProspecto").value =
                                    respuesta['response']['cod_prospecto'];
                                document.getElementById("razonSocRegVta").value = respuesta[
                                    'response']['dsc_razon_social'];
                                document.getElementById("direccRegVta").value = respuesta[
                                    'response']['dsc_direccion'];
                                document.getElementById("direccRefRegVta").value =
                                    respuesta['response']['dsc_direccion_referencia'];
                                document.getElementById("telf1RegVta").value = respuesta[
                                    'response']['dsc_telefono_1'];
                                document.getElementById("telf2RegVta").value = respuesta[
                                    'response']['dsc_telefono_2'];
                                document.getElementById("correoRegVta").value = respuesta[
                                    'response']['dsc_correo'];
                                document.getElementById("edoCivilRegVta").value = respuesta[
                                    'response']['cod_estado_civil'];
                                document.getElementById("sexoRegVta").value = respuesta[
                                    'response']['cod_sexo'];
                                if (respuesta['response']['fch_nacimiento'] !=
                                    '1900-01-01T00:00:00') {
                                    document.getElementById("fchNacRegVta").value =
                                        respuesta['response']['fch_nacimiento'];
                                }
                                flatpickr("#fchNacRegVta", {
                                    locale: "es",
                                    altInput: true,
                                ...
                                setTimeout(function() {
                                    provinProsp.value = respuesta["response"][
                                        "cod_provincia"
                                    ];
                                    provinProsp.dispatchEvent(changeEvent);
                                    setTimeout(function() {
                                        dttoProsp.value = respuesta[
                                            "response"]["cod_distrito"];
                                        dttoProsp.dispatchEvent(
                                            changeEvent);
                                    }, 3000);
                                }, 3000);
                            }
                        ...
                        Swal.fire({
                            title: 'Error!',
                            text: 'El numero de documento ' + respuesta['response'][
                                    'dsc_documento'
                                ] +
                                ' pertenece a un prospecto registrado por otro consejero.',
                            icon: 'warning',
                            confirmButtonColor: '#D5161E',
                        })
                        document.getElementById("formRegVenta").reset();
    ...
    numDoc2titInput.addEventListener("input", function(event) {
        ...
        if (inputValue.length !== '') {
            if (tam < 12) {
                // Verificar si se ingresaron 9 dígitos
                if (inputValue.length != tam) {
                    numDoc2titInput.setCustomValidity("Debe ingresar " + tam +
                        " dígitos"); // Mostrar mensaje de error
    ...
    numDoc2titInput.addEventListener("blur", function(event) {
        $.ajax({
            ...
            dataType: 'json',
            data: {
                'tipoDoc': document.getElementById("tipoDoc2doRegVta").value,
                'dscDocumento': document.getElementById("numDoc2doRegVta").value
            },
            success: function(respuesta) {
                if (respuesta && respuesta['dsc_documento'] != null) {
                    document.getElementById("nombres2doRegVta").value = respuesta['response'][
                        'dsc_nombre'
                    ];
                    document.getElementById("apellP2doRegVta").value = respuesta['response'][
                        'dsc_apellido_paterno'
                    ];
                    document.getElementById("apellM2doRegVta").value = respuesta['response'][
                        'dsc_apellido_materno'
                    ];
                    document.getElementById("razonSoc2doRegVta").value = respuesta['response'][
                        'dsc_razon_social'
                    ];
                    document.getElementById("direcc2doRegVta").value = respuesta['response'][
                        'dsc_direccion'
                    ];
                    document.getElementById("telf12doRegVta").value = respuesta['response'][
                        'dsc_telefono_1'
                    ];
                    document.getElementById("telf22doRegVta").value = respuesta['response'][
                        'dsc_telefono_2'
                    ];
                    document.getElementById("correo2doRegVta").value = respuesta['response'][
                        'dsc_correo'
                    ];
                    document.getElementById("edoCivil2doRegVta").value = respuesta['response'][
                        'cod_edo_civil_2do'
                    ];
                    document.getElementById("fchNac2doRegVta").value = respuesta['response'][
                        'fch_nacimiento_2do'
                    ];
                    flatpickr("#fchNac2doRegVta", {
                        locale: "es",
    ...
    numDocAvalInput.addEventListener("input", function(event) {
        ...
        if (inputValue.length !== '') {
            if (tam < 12) {
                // Verificar si se ingresaron 9 dígitos
                if (inputValue.length != tam) {
                    numDocAvalInput.setCustomValidity("Debe ingresar " + tam +
                        " dígitos"); // Mostrar mensaje de error
    ...
    numDocAvalInput.addEventListener("blur", function(event) {
        $.ajax({
            ...
            dataType: 'json',
            data: {
                'tipoDoc': document.getElementById("tipoDocAval").value,
                'dscDocumento': document.getElementById("numDocAval").value
            },
            success: function(respuesta) {
                if (respuesta) {
                    document.getElementById("nombresAval").value = respuesta['response'][
                        'dsc_nombre'
                    ];
                    document.getElementById("apellPAval").value = respuesta['response'][
                        'dsc_apellido_paterno'
                    ];
                    document.getElementById("apellMAval").value = respuesta['response'][
                        'dsc_apellido_materno'
                    ];
                    document.getElementById("razonSocAval").value = respuesta['response'][
                        'dsc_razon_social'
                    ];
                    document.getElementById("direccAval").value = respuesta['response'][
                        'dsc_direccion'
                    ];
                    document.getElementById("telef1Aval").value = respuesta['response'][
                        'dsc_telefono_1'
                    ];
                    document.getElementById("telef2Aval").value = respuesta['response'][
                        'dsc_telefono_2'
                    ];
                    document.getElementById("correoAval").value = respuesta['response'][
                        'dsc_correo'
                    ];
                    document.getElementById("edoCivilAval").value = respuesta['response'][
                        'cod_edo_civil_aval'
                    ];
                    document.getElementById("fchNacAval").value = respuesta['response'][
                        'fch_nacimiento_aval'
                    ];
                    flatpickr("#fchNacAval", {
                        locale: "es",
    ...
    numDocAddBenefInput.addEventListener("input", function(event) {
        ...
        if (inputValueBenef.length !== '') {
            if (tam < 12) {
                // Verificar si se ingresaron 9 dígitos
                if (inputValueBenef.length != tam) {
                    numDocAddBenefInput.setCustomValidity("Debe ingresar " + tam +
                        " dígitos"); // Mostrar mensaje de error
    ...
    CuotaInicial.addEventListener("change", function(event) {
        ...
        var num_interes = ($('option:selected', tipoInteres).attr('data') != 'undefined') ? $('option:selected',
            tipoInteres).attr('data') : 0;
        ...
        var iniInt = document.getElementById("cuoIniInt").value;
        var AuxTotal = 0;
        var auxNumCuo = 0;

        if (iniInt > 1) {
            AuxTotal = imp_saldo / num_cuota;
            auxNumCuo = num_cuota - iniInt;
            imp_saldo = AuxTotal * auxNumCuo;
            num_cuota = auxNumCuo;
        }
        ...
        if (document.getElementById("codTasa").value == '' || document.getElementById("codTasa").value ==
            '031') {
            imp_cuota = imp_saldo / num_cuota;
            if (serviciosAgregados.length == 1) {
                document.getElementById("imp_cuota").value = Number(imp_cuota).toFixed(0);
            } else {
                document.getElementById("imp_cuota").value = Number(imp_cuota).toFixed(2);
            }
        } else {
            imp_cuota = imp_saldo * ((interes * (1 + interes) ** num_cuota) / (((1 + interes) ** num_cuota) -
                1));
            if (serviciosAgregados.length == 1) {
                document.getElementById("imp_cuota").value = Number(imp_cuota).toFixed(0);
            } else {
    ...
    tipoCuota.addEventListener("change", function(event) {
        ...
        var cuoIniInt = document.getElementById("cuoIniInt");
        //cuoIniInt.value = 1;
        cuoIniInt.removeAttribute('disabled');
    });
    ...
    //-----------------------------------------CALCULAR IMPUESTO CUOTA------------------------------------------
    var iniInteres = document.getElementById("cuoIniInt");
    iniInteres.addEventListener("change", function(event) {
        ...
        if (iniInt >= num_cuota) {
            Swal.fire({
                title: 'Info!',
                text: 'El valor no puede ser mayor que la cantidad de Cuotas servicio.',
                icon: 'info',
                confirmButtonColor: '#D5161E',
                confirmButtonText: 'Aceptar'
            }).then((result) => {
    ...
    phoneInput.addEventListener("input", function(event) {
        ...
        var pais = document.getElementById("paisRegVta").value;
        ...
        if (pais === '00001') {
            if (phone.length > 12) {
                phone = phone.slice(0, 12); // limitar longitud a 12
            }
            phoneInput.value = phone;

            if (phone.length >= 9 && phone.length <= 12) {
                phoneInput.setCustomValidity(""); // válido
            } else {
                phoneInput.setCustomValidity("Ingrese un número de teléfono válido (9-12 dígitos)");
            }

        } else {
            // Para otros países: no limitamos longitud, solo limpiamos a dígitos
            phoneInput.value = phone;
            phoneInput.setCustomValidity(""); // sin error de validación
        }
    });
    ...
    phoneInput2.addEventListener("input", function(event) {
        ...
        if (pais === '00001') {
            ...
            if (phone.length >= 9 && phone.length <= 12) {
                phoneInput2.setCustomValidity(""); // válido
            } else {
                phoneInput2.setCustomValidity("Ingrese un número de teléfono válido (9-12 dígitos)");
            }

        } else {
            // Para otros países: no limitamos longitud, solo limpiamos a dígitos
            phoneInpu2t.value = phone;
            phoneInput2.setCustomValidity(""); // sin error de validación
        }
    });
    ...
    phoneInput3.addEventListener("input", function(event) {
        var phone = event.target.value;
        var pais = document.getElementById("pais2doRegVta").value;
        ...
        if (pais === '00001') {
            ...
            phoneInput3.value = phone;

            if (phone.length >= 9 && phone.length <= 12) {
                phoneInput3.setCustomValidity(""); // válido
            } else {
                phoneInput3.setCustomValidity("Ingrese un número de teléfono válido (9-12 dígitos)");
            }

        } else {
            // Para otros países: no limitamos longitud, solo limpiamos a dígitos
            phoneInput3.value = phone;
            phoneInput3.setCustomValidity(""); // sin error de validación
        }
    });
    ...
    phoneInput4.addEventListener("input", function(event) {
        ...
        if (pais === '00001') {
            ...
            phoneInput4.value = phone;

            if (phone.length >= 9 && phone.length <= 12) {
                phoneInput4.setCustomValidity(""); // válido
            } else {
                phoneInput4.setCustomValidity("Ingrese un número de teléfono válido (9-12 dígitos)");
            }

        } else {
            // Para otros países: no limitamos longitud, solo limpiamos a dígitos
            phoneInput4.value = phone;
            phoneInput4.setCustomValidity(""); // sin error de validación
        }
    });
    ...
    phoneInput5.addEventListener("input", function(event) {
        var phone = event.target.value;
        var pais = document.getElementById("paisAval").value;
        ...
        if (pais === '00001') {
            ...
            phoneInput5.value = phone;

            if (phone.length >= 9 && phone.length <= 12) {
                phoneInput5.setCustomValidity(""); // válido
            } else {
                phoneInput5.setCustomValidity("Ingrese un número de teléfono válido (9-12 dígitos)");
            }

        } else {
            // Para otros países: no limitamos longitud, solo limpiamos a dígitos
            phoneInput5.value = phone;
            phoneInput5.setCustomValidity(""); // sin error de validación
        }
    });
    ...
    phoneInput6.addEventListener("input", function(event) {
        ...
        if (pais === '00001') {
            ...
            phoneInput6.value = phone;

            if (phone.length >= 9 && phone.length <= 12) {
                phoneInput6.setCustomValidity(""); // válido
            } else {
                phoneInput6.setCustomValidity("Ingrese un número de teléfono válido (9-12 dígitos)");
            }

        } else {
            // Para otros países: no limitamos longitud, solo limpiamos a dígitos
            phoneInput6.value = phone;
            phoneInput6.setCustomValidity(""); // sin error de validación
        }
    });
    ...
    var fechaMasUnMes = new Date(fechaActual.getFullYear(), fechaActual.getMonth() + 1, fechaActual
        .getDate()); // Sumar un mes a la fecha actual
    ...
    $(document).ready(function() {
        ...
        var lastDayOfMonth = new Date(currentDate.getFullYear(), currentDate.getMonth() + 1, currentDate
            .getDay());
        ...
        setTimeout(function() {
            ...
            if (cod_prospecto !== '') {
                ...
                ListarDocumentos(cod_prospecto)
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        document.getElementById("codConsejeroVend").value = result[
                            "response"]["cod_consejero"];
                        ...
                        if (dsc_estado == 'VENTA' || dsc_estado == 'CIERRE') {
                            ...
                            document.getElementById("AprobarVenta").bootstrapToggle(
                                'readonly');
                            document.getElementById("tipoNec").bootstrapToggle('readonly');
                            ...
                            if (flg_administrador == 'SI' || flg_supervisor == 'SI' ||
                                flg_jefe == 'SI') {
                        ...
                        document.getElementById("razonSocRegVta").value = result["response"]
                            ["dsc_razon_social"];
                        document.getElementById("apellPRegVta").value = result["response"][
                            "dsc_apellido_paterno"
                        ];
                        document.getElementById("apellMRegVta").value = result["response"][
                            "dsc_apellido_materno"
                        ];
                        document.getElementById("nombresRegVta").value = result["response"][
                            "dsc_nombre"
                        ];

                        document.getElementById("razSocCompVtaRegVta").value = result[
                            "response"]["dsc_razon_social_comprobante"];
                        document.getElementById("rucCompVtaRegVta").value = result[
                            "response"]["dsc_ruc"];

                        var cod_tipo_comprobante = document.getElementById("compVtaRegVta");
                        cod_tipo_comprobante.value = result["response"][
                        ...
                        document.getElementById("numDocRegVta").value = result["response"][
                            "dsc_documento"
                        ];
                        ...
                        dptoProsp.dispatchEvent(
                            changeEvent); // Desencadena el evento "change"
                        ...
                        setTimeout(function() {
                            ...
                            provinProsp.dispatchEvent(changeEvent);
                            setTimeout(function() {
                                dttoProsp.value = result["response"][
                                    "cod_distrito"
                                ];
                                dttoProsp.dispatchEvent(changeEvent);
                            }, 2500);
                        ...
                        document.getElementById("direccRegVta").value = result["response"][
                            "dsc_direccion"
                        ];
                        document.getElementById("direccRefRegVta").value = result[
                            "response"]["dsc_direccion_referencia"];
                        document.getElementById("telf1RegVta").value = result["response"][
                            "dsc_telefono_1"
                        ];
                        document.getElementById("telf2RegVta").value = result["response"][
                            "dsc_telefono_2"
                        ];
                        document.getElementById("correoRegVta").value = result["response"][
                            "dsc_correo"
                        ];
                        document.getElementById("sexoRegVta").value = result["response"][
                            "cod_sexo"
                        ];
                        document.getElementById("edoCivilRegVta").value = result["response"]
                            ["cod_estado_civil"];
                        ...
                        document.getElementById("apellP2doRegVta").value = result[
                            "response"]["dsc_apellido_paterno_2do"];
                        document.getElementById("apellM2doRegVta").value = result[
                            "response"]["dsc_apellido_materno_2do"];
                        document.getElementById("nombres2doRegVta").value = result[
                            "response"]["dsc_nombre_2do"];

                        var tipoDoc2tit = document.getElementById("tipoDoc2doRegVta");
                        tipoDoc2tit.value = result["response"]["cod_tipo_documento_2do"];

                        document.getElementById("numDoc2doRegVta").value = result[
                            "response"]["dsc_documento_2do"];
                        ...
                        setTimeout(function() {
                            prov2Tit.value = result["response"][
                                "cod_provincia_2do"
                            ];
                            prov2Tit.dispatchEvent(changeEvent);
                            setTimeout(function() {
                                dtto2Tit.value = result["response"][
                                    "cod_distrito_2do"
                                ];
                        ...
                        document.getElementById("direcc2doRegVta").value = result[
                            "response"]["dsc_direccion_2do"];
                        document.getElementById("telf12doRegVta").value = result["response"]
                            ["dsc_telefono_1_2do"];
                        document.getElementById("telf22doRegVta").value = result["response"]
                            ["dsc_telefono_2_2do"];
                        document.getElementById("correo2doRegVta").value = result[
                            "response"]["dsc_correo_2do"];
                        //-------------------------campos nuevos---------------------
                        document.getElementById("edoCivil2doRegVta").value = result[
                            "response"]["cod_estado_civil_2do"];
                        auxFechaNac2do = result["response"]["fch_nacimiento_2do"].split(
                            'T');
                        if (result['response']['fch_nacimiento_2do'] !=
                            '1900-01-01T00:00:00') {
                            document.getElementById("fchNac2doRegVta").value =
                                auxFechaNac2do[0];
                        }
                        flatpickr("#fchNac2doRegVta", {
                            locale: "es",
                        ...
                        document.getElementById("apellPAval").value = result["response"][
                            "dsc_apellido_paterno_aval"
                        ];
                        document.getElementById("apellMAval").value = result["response"][
                            "dsc_apellido_materno_aval"
                        ];
                        document.getElementById("nombresAval").value = result["response"][
                            "dsc_nombre_aval"
                        ];
                        ...
                        document.getElementById("numDocAval").value = result["response"][
                            "dsc_documento_aval"
                        ];
                        ...
                        setTimeout(function() {
                            provAval.value = result["response"][
                                "cod_provincia_aval"
                            ];
                            provAval.dispatchEvent(changeEvent);
                            setTimeout(function() {
                                dttoAval.value = result["response"][
                                    "cod_distrito_aval"
                                ];
                        ...
                        document.getElementById("direccAval").value = result["response"][
                            "dsc_direccion_aval"
                        ];
                        document.getElementById("telef1Aval").value = result["response"][
                            "dsc_telefono_1_aval"
                        ];
                        document.getElementById("telef2Aval").value = result["response"][
                            "dsc_telefono_2_aval"
                        ];
                        document.getElementById("correoAval").value = result["response"][
                            "dsc_correo_aval"
                        ];
                        //----------------campos nuevos----------------
                        document.getElementById("edoCivilAval").value = result["response"][
                            "cod_estado_civil_aval"
                        ];
                        auxFechaNacAval = result["response"]["fch_nacimiento_aval"].split(
                            'T');
                        if (result['response']['fch_nacimiento_aval'] !=
                            '1900-01-01T00:00:00') {
                            document.getElementById("fchNacAval").value = auxFechaNacAval[
                                0];
                        }
                        flatpickr("#fchNacAval", {
                            locale: "es",
                        ...
                        document.getElementById("tipoPrograma").value = result["response"][
                            "cod_tipo_programa"
                        ];
                        ...
                        setTimeout(function() {
                            tipoPlataf.value = result["response"][
                                "cod_tipo_plataforma"
                            ];
                            tipoPlataf.dispatchEvent(changeEvent);
                            setTimeout(function() {
                                plataforma.value = result["response"][
                                    "cod_plataforma"
                                ];
                                plataforma.dispatchEvent(changeEvent);
                                setTimeout(function() {
                                    areaPlataf.value = result[
                                        "response"][
                                        "cod_area_plataforma"
                                    ];
                                    areaPlataf.dispatchEvent(
                                        changeEvent);
                                    setTimeout(function() {
                                        ejeX.value = result[
                                            "response"][
                        ...
                        $.ajax({
                            ...
                            success: function(resultado) {
                                ...
                                resultado['response'].forEach(function(
                                    servicio) {
                                    var datos = {
                                        "cod_prospecto": servicio[
                                            "cod_prospecto"],
                                        "cod_servicio": servicio[
                                            "cod_servicio"],
                                        "dsc_servicio": servicio[
                                            "dsc_servicio"],
                                        "flg_contado": "NO",
                                        "cod_moneda": "SOL",
                                        "imp_precio": servicio[
                                            "imp_precio_venta"],
                                        "imp_precio_lista": servicio[
                                            "imp_precio_lista"],
                                        "imp_precio_cuoi": servicio[
                                            "imp_cui"],
                                        "imp_precio_foma": servicio[
                                            "imp_foma"],
                                        "flg_ds_compartido": "NO",
                                        "imp_min_cuoi": servicio[
                                            "imp_cui"],
                                        "por_descuento": servicio[
                                            "por_descuento"],
                                        "num_ctd": servicio[
                                            "num_ctd"],
                                        "imp_descuento_adicional": servicio[
                                            "imp_descuento_adicional"
                                        ],
                                        "num_linea": servicio[
                                            "num_linea"],
                                        "flg_dsepultura": servicio[
                                            "flg_dsepultura"]
                                    }
                            ...
                            success: function(resultado) {
                                ...
                                resultado['response'].forEach(function(
                                    ...
                                    if (documento["num_linea"] == '5') {
                                        document.getElementById(
                                                "DniAvalAdj1").classList
                                            .add('is-valid');
                                    }
                                    if (documento["num_linea"] == '6') {
                                        document.getElementById(
                                                "DniAvalAdj2").classList
                                            .add('is-valid');
                                    }
                                    if (documento["num_linea"] == '7') {
                                        document.getElementById(
                                                "recServAdj").classList
                                            .add('is-valid');
                                    }
                                    ...
                                    if (documento["num_linea"] ==
                                        '10') {
                                        document.getElementById(
                                                "ActaDefAdj").classList
                                            .add('is-valid');
                                    }
                                    if (documento["num_linea"] ==
                                        '11') {
                                        document.getElementById(
                                                "CertDefAAdj").classList
                                            .add('is-valid');
                                    }
                                    if (documento["num_linea"] ==
                                        '16') {
                                        document.getElementById(
                                                "CertDefBAdj").classList
                                            .add('is-valid');
                                    }
                                    if (documento["num_linea"] ==
                                        '12') {
                        ...
                        setTimeout(function() {
                            ...
                            document.getElementById("impCuoi").value = result[
                                "response"]["imp_cui"];
                            //document.getElementById("impMinCuoi").value=parseFloat(result["response"]["imp_cui"]);
                            document.getElementById("impSaldo").value = result[
                                "response"]["imp_saldo_financiar"];
                            if (result["response"]["cod_tasa"] != '') {
                                document.getElementById("codTasa").value = result[
                                    "response"]["cod_tasa"];
                            }
                            if (result["response"]["cod_cuota_servicio"] != '') {
                                document.getElementById("codCuotaServ").value =
                                    result["response"]["cod_cuota_servicio"];
                            }
                            if (result["response"]["num_cuota_interes"] != '') {
                                document.getElementById("cuoIniInt").value = result[
                                    "response"]["num_cuota_interes"];
                                document.getElementById("cuoIniInt")
                                    .removeAttribute('disabled');
                            }
                            document.getElementById("impFoma").value = result[
                                "response"]["imp_foma"];
                            //document.getElementById("codCuotaFoma").value=result["response"]["cod_cuota_foma"];
                            document.getElementById("numOpeRegVta").value = result[
                                "response"]["num_operacion"];
                            document.getElementById("imp_cuota").value = result[
                                "response"]["imp_cuota"];
                            document.getElementById("imp_separacion").value =
                                Number(result["response"]["imp_separacion"])
                                .toFixed(2);
                            var auxFecha = result["response"]["fch_1er_vencimiento"]
                                .split('T');
                            document.getElementById("fch1erVcto").value = auxFecha[
                                0];
                            document.getElementById("obsvRegVentas").value = result[
                                "response"]["dsc_observaciones"];
                            if (document.getElementById("fch1erVcto").value ==
                                '1900-01-01') {
                ...
                $.ajax({
                    ...
                    success: function(resultBenef) {
                        ...
                        resultBenef['response'].forEach(function(word) {
                            ...
                            var fch_nacimiento1 = fch1.toLocaleDateString('en-GB', {
                                day: '2-digit',
                                month: '2-digit',
                                year: 'numeric'
                            }).replace(/ /g, '-');
                            ...
                            index = 0;
                            fila += '<tr>' +
                                '<td>' + word['dsc_tipo_documento'] + '-' + word[
                                    'dsc_documento'] + '</td>' +
                                '<td>' + word['dsc_nombres'] + ' ' + word[
                                    'dsc_apellido_paterno'] + ' ' + word[
                                    'dsc_apellido_materno'] + '</td>' +
                                '<td>' + fch_nacimiento1 + '</td>' +
                                '<td>' + word['dsc_parentesco'] + '</td>' +
                                '<td>' + word['cod_sexo'] + '</td>' +
                                '<td>' + word['dsc_estado_civil'] + '</td>' +
                                '<td><div class="acciones"><button type="button" class="btn btn-danger BtnverdeRemanso form-remanso" id="botonEditar' +
                                index + '" onClick="editarFilaBenef(' + word[
                                    'num_linea'] +
                                ')"><span class="bi bi-pencil"></span></button><button class="btn btn-danger form-remanso" type="button" onClick="eliminarFila(' +
                                index + ',' + "'SI'" + ',' + word['dsc_documento'] +
                                ',' + word['num_linea'] + ');" id="botonEliminar' +
                                index +
                                '"><span class="bi bi-x-lg"></span></button></div></td>' +
                                '</tr>';
                            ...
                            var filaData = {
                                ...
                                'cod_tipo_documento': word[
                                    'cod_tipo_documento'],
                                'dsc_documento': word['dsc_documento'],
                                'dsc_apellido_paterno': word[
                                    'dsc_apellido_paterno'],
                                'dsc_apellido_materno': word[
                                    'dsc_apellido_materno'],
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        fileInput.addEventListener("change", function() {
            ...
            if (clases.contains("is-valid")) {
                Swal.fire({
                    title: 'Info!',
                    text: 'Ya tiene el DNI del titular guardado, desea sobreescribirlo?',
                    icon: 'info',
                    showDenyButton: true,
                    confirmButtonColor: '#D5161E',
                    denyButtonColor: '#d33',
    ...
    document.addEventListener("DOMContentLoaded", function() {
        const fileInput = document.getElementById("DniFall");
        const errorMessage = document.getElementById("error-message");
        ...
        fileInput.addEventListener("change", function() {
            ...
            if (clases.contains("is-valid")) {
                Swal.fire({
                    title: 'Info!',
                    text: 'Ya tiene el DNI del fallecido guardado, desea sobreescribirlo?',
                    icon: 'info',
                    showDenyButton: true,
                    confirmButtonColor: '#D5161E',
                    denyButtonColor: '#d33',
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        fileInput.addEventListener("change", function() {
            ...
            if (clases.contains("is-valid")) {
                Swal.fire({
                    title: 'Info!',
                    text: 'Ya tiene el DNI del segundo titular guardado, desea sobreescribirlo?',
                    icon: 'info',
                    showDenyButton: true,
                    confirmButtonColor: '#D5161E',
                    denyButtonColor: '#d33',
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        fileInput.addEventListener("change", function() {
            ...
            if (clases.contains("is-valid")) {
                Swal.fire({
                    title: 'Info!',
                    text: 'Ya tiene un Comprobante de Pago guardado, desea sobreescribirlo?',
                    icon: 'info',
                    showDenyButton: true,
                    confirmButtonColor: '#D5161E',
                    denyButtonColor: '#d33',
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        fileInput.addEventListener("change", function() {
            ...
            if (clases.contains("is-valid")) {
                Swal.fire({
                    title: 'Info!',
                    text: 'Ya tiene un Recibo Provisional guardado, desea sobreescribirlo?',
                    icon: 'info',
                    showDenyButton: true,
                    confirmButtonColor: '#D5161E',
                    denyButtonColor: '#d33',
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        fileInput.addEventListener("change", function() {
            ...
            if (clases.contains("is-valid")) {
                Swal.fire({
                    title: 'Info!',
                    text: 'Ya tiene una Hoja de Lapida NI guardada, desea sobreescribirlo?',
                    icon: 'info',
                    showDenyButton: true,
                    confirmButtonColor: '#D5161E',
                    denyButtonColor: '#d33',
    ...
    // function cargarDrive(nombreInput, codProspecto, nombre, numLinea, accionDocumentos, folderId) {
    //     var fileInput = document.getElementById(nombreInput);
    //     const formData = new FormData();
    //     formData.append("file", fileInput.files[0]);
    //     formData.append("codProspecto", codProspecto);
    ...
    //     formData.append("numLinea", numLinea);
    //     formData.append("accionDocumentos", accionDocumentos);
    //     formData.append("folderId", folderId); // nuevo
    ...
    function cargarDrive(nombreInput, codProspecto, nombre, numLinea, accionDocumentos, folderId) {
        const fileInput = document.getElementById(nombreInput);
        const formData = new FormData();
        formData.append("file", fileInput.files[0]);
        formData.append("codProspecto", codProspecto);
        formData.append("nombre", nombre);
        ...
        return axios.post('../api/guardaDocumentoAdjunto', formData)
            .then(response => {
                if (response.data.status === 'ok') {
                    // console.log(`Archivo subido: ${response.data.ruta}`);
                }
            })
            .catch(error => console.error(error));
    }
    ...
    addBeneficiario.addEventListener("click", function() {
        ...
        var fch_nacimiento1 =
            fch1; //.toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric'}).replace(/ /g, '-');
        ...
        editarBoton.classList.add('btn-danger');
        ...
        editarBoton.addEventListener('click', function() {
            var filaIndex = this.id.replace('botonEditar',
                ''); // Obtiene el índice de la fila desde el ID del botón
            editarFilaBenef(filaIndex);
        });

        eliminarBoton.addEventListener('click', function() {
            var filaIndex = this.id.replace('botonEliminar',
                ''); // Obtiene el índice de la fila desde el ID del botón
    ...
    actualizarBeneficiario.addEventListener("click", function() {
        ...
        fila.cells[0].textContent = document.getElementById("tipoDocAddBenef").options[document.getElementById(
            "tipoDocAddBenef").selectedIndex].text + "-" + document.getElementById("numDocAddBenef").value;
        fila.cells[1].textContent = document.getElementById("nombresAddBenef").value.toUpperCase() + " " +
            document.getElementById("apellPAddBenef").value.toUpperCase() + " " + document.getElementById(
                "apellMAddBenef").value.toUpperCase();
        ...
        fila.cells[3].textContent = document.getElementById("parentescoAddBenef").options[document
            .getElementById("parentescoAddBenef").selectedIndex].text;
        fila.cells[4].textContent = document.getElementById("sexoAddBenef").value;
        fila.cells[5].textContent = document.getElementById("edoCivilAddBenef").options[document.getElementById(
            "edoCivilAddBenef").selectedIndex].text;
    ...
    botonGuarda.addEventListener("click", function() {
        ...
        if (document.getElementById("pais2doRegVta").value == '00001' && document.getElementById(
                "numDoc2doRegVta").value != '') {
            if (document.getElementById("prov2doRegVta").value == '' || document.getElementById("prov2doRegVta")
                .value == null) {
                Swal.fire({
                    title: 'Error!',
            ...
            if (document.getElementById("dtto2doRegVta").value == '' || document.getElementById("dtto2doRegVta")
                .value == null) {
                Swal.fire({
                    title: 'Error!',
        ...
        if (document.getElementById("tipoDocRegVta").value == '' || document.getElementById("tipoDocRegVta")
            .value == null) {
            Swal.fire({
                title: 'Error!',
        ...
        if (document.getElementById("numDocRegVta").value.trim() == '' || document.getElementById(
                "numDocRegVta").value == null) {
            Swal.fire({
                title: 'Error!',
        ...
        if ((document.getElementById("numDoc2doRegVta").value != '' || document.getElementById(
                "nombres2doRegVta").value != '' || document.getElementById("apellP2doRegVta").value != '') && (
                document.getElementById("tipoDoc2doRegVta").value == '' || document.getElementById(
                    "tipoDoc2doRegVta")).value == null) {
            Swal.fire({
                title: 'Error!',
        ...
        if ((document.getElementById("tipoDoc2doRegVta").value != '' || document.getElementById(
                "nombres2doRegVta").value != '' || document.getElementById("apellP2doRegVta").value != '') && (
                document.getElementById("numDoc2doRegVta").value == '' || document.getElementById(
                    "numDoc2doRegVta")).value == null) {
            Swal.fire({
                title: 'Error!',
        ...
        if (tipo_nec == 'NI' && document.getElementById("numDocAval").value != '' && (document.getElementById(
                "tipoDocAval").value == '' || document.getElementById("tipoDocAval").value == null)) {
            Swal.fire({
                title: 'Error!',
        ...
        if (document.getElementById("tipoDocRegVta").value == 'DI004') {
            ...
            flgJuridico = 'NO';
            dscTitular = document.getElementById("apellPRegVta").value.toUpperCase() + ' ' + document
                .getElementById("apellMRegVta").value.toUpperCase() + ', ' + document.getElementById(
                    "nombresRegVta").value.toUpperCase();
        }
        ...
        var inicioInt = (document.getElementById("cuoIniInt").value != '') ? parseInt(document.getElementById(
            "cuoIniInt").value) : 0;
        ...
        var prospecto = {
            ...
            'dsc_prospecto_2do': document.getElementById("nombres2doRegVta").value.toUpperCase() + ' ' +
                document.getElementById("apellP2doRegVta").value.toUpperCase() + ' ' + document
                .getElementById("apellM2doRegVta").value.toUpperCase(),
            ...
            'dsc_prospecto_aval': document.getElementById("nombresAval").value.toUpperCase() + ' ' +
                document.getElementById("apellPAval").value.toUpperCase() + ' ' + document.getElementById(
                    "apellMAval").value.toUpperCase(),
            ...
            'imp_foma': foma,
            'imp_cuota': cuota,
            'imp_separacion': (document.getElementById("imp_separacion").value == '') ? 0 : document
                .getElementById("imp_separacion").value,
            'num_cuotas_interes': inicioInt
        };
                ...
                $.ajax({
                    ...
                    success: function(respuesta) {
                        ...
                        filasArray.forEach(function(fila) {
                            ...
                            fila['fch_nacimiento'] = fecha4BD(fila[
                                'fch_nacimiento']);
                        ...
                        serviciosAgregados.forEach(function(fila) {
                            ...
                            fila['cod_prospecto'] = cod_prospecto;
                            fila['cod_contrato_base'] = document.getElementById(
                                "cttoBase").value;
                            fila['num_servicio_base'] = document.getElementById(
                                "numServBase").value;
                            fila['cod_cuota_foma'] = document.getElementById(
                                "codCuotaFoma").value;
                            fila['cod_cuota_servicio'] = document.getElementById(
                                "codCuotaServ").value;
                            fila['num_cuotas_interes'] = document.getElementById(
                                "cuoIniInt").value;
                            fila['cod_tasa'] = document.getElementById("codTasa")
                                .value;
                            fila['fch_1er_vencimiento'] = document.getElementById(
                                "fch1erVcto").value;
                        ...
                        const hasFiles = [
                            "DniAdj1", "DniFall", "Dni2Adj1",
                            "DniAvalAdj1", "DniAvalAdj2", "recServAdj",
                            "comprobanteAdj",
                            "RecSepAdj", "ActaDefAdj", "CertDefAAdj", "CertDefBAdj",
                            "NecroAdj", "ConstInhuAdj", "AutSanitAdj", "OtrosAdj",
                            "declaracionFile", "firmaTitular", "declaracionFile_2",
                            "firmaTitular_2"
                        ].some(id => document.getElementById(id)?.value !== '');

                        if (hasFiles) {
                            axios.post('../api/crearCarpetaProspecto', {
                                    codProspecto: cod_prospecto
                                })
                                .then(async response => {
                                    ...
                                    const archivos = [{
                                            id: "DniAdj1",
                                            descripcion: "DNI_Titular",
                                            tipo: 1
                                        },
                                        {
                                            id: "DniFall",
                                            descripcion: "DNI_Fallecido",
                                            tipo: 2
                                        },
                                        {
                                            id: "Dni2Adj1",
                                            descripcion: "DNI_Alterno",
                                            tipo: 3
                                        },
                                        // {
                                        //     id: "Dni2Adj2",
                                        //     descripcion: "DNI_Alterno_reverso",
                                        //     tipo: 4
                                        // },
                                        {
                                            id: "DniAvalAdj1",
                                            descripcion: "DNI_Aval_anverso",
                                            tipo: 5
                                        },
                                        {
                                            id: "DniAvalAdj2",
                                            descripcion: "DNI_Aval_reverso",
                                            tipo: 6
                                        },
                                        {
                                            id: "recServAdj",
                                            descripcion: "Hoja_facturacion",
                                            tipo: 7
                                        },
                                        {
                                            id: "comprobanteAdj",
                                        ...
                                        {
                                            id: "RecSepAdj",
                                            descripcion: "Recibo_provisional",
                                            tipo: 9
                                        },
                                        {
                                            id: "ActaDefAdj",
                                            descripcion: "Acta_de_defuncion",
                                            tipo: 10
                                        },
                                        {
                                            id: "CertDefAAdj",
                                            descripcion: "Certificado_de_defuncion_A",
                                            tipo: 11
                                        },
                                        {
                                            id: "CertDefBAdj",
                                            descripcion: "Certificado_de_defuncion_B",
                                            tipo: 16
                                        },
                                        {
                                            id: "NecroAdj",
                                            descripcion: "Necropsia",
                                            tipo: 12
                                        },
                                        {
                                            id: "ConstInhuAdj",
                                            descripcion: "Hoja_lapida_NI",
                                            tipo: 13
                                        },
                                        {
                                            id: "AutSanitAdj",
                                            descripcion: "Autorizacion_sanitaria",
                                            tipo: 14
                                        },
                                        {
                                            id: "OtrosAdj",
                                        ...
                                        {
                                            id: "declaracionFile",
                                            descripcion: "Declaracion_Jurada",
                                            tipo: 17
                                        },
                                        {
                                            id: "firmaTitular",
                                            descripcion: "Firma_Titular",
                                            tipo: 18
                                        },

                                        {
                                            id: "declaracionFile_2",
                                            descripcion: "Declaracion_Jurada_2",
                                            tipo: 19
                                        },

                                        {
                                            id: "firmaTitular_2",
                                            descripcion: "Firma_Titular_2",
                                            tipo: 20
                                        },
                                    ];
                            ...
                            console.log("no hay archivos que subir, no se crea carpeta");
                            $("#overlay_load").hide();
                            Swal.fire({
                                title: 'Guardado',
                                text: cod_prospecto,
    ...
    function ModoVista() {
        ...
        if (flg_firmante == 'SI' || dsc_estado == 'CIERRE') {
            ...
            document.getElementById("cuoIniInt").disabled = true;
            ...
            document.getElementById("DniFall").disabled = true;
