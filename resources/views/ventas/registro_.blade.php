                                    ...
                                    <div id="collapseServicios" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <div class="row">
												...
												<div class="col-md-2 mb-3">
                                                    <label for="inputText" class="col-form-label">Inicio Cuota interés:
                                                    </label>
                                                </div>
                                                <div class="col-md-2 mb-3">
												<input type="number" min="0" max="83" class="form-control form-remanso align-right" name="cuoIniInt" id="cuoIniInt" disabled>
                                                </div>
                                                <div class="col-md-2 mb-3">
                                    ...
                                    <div id="collapseDocumentos" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <label for="inputText" class="col-form-label">Comprobante de Pago:
                                                    </label>
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    {{-- <input class="form-control form-remanso form-control-sm"
                                                ...
                                                <div class="col-md-2 mb-3" id="tituloRecSep">
                                                    <label for="inputText" class="col-form-label">Recibo Provisional:
                                                    </label>
                                                </div>
                                                ...
                                                <div class="col-md-2 mb-3" style="display: none"
                                                    ...
                                                    <label for="inputText" class="col-form-label">Hoja Lapida NI: </label>
                                                </div>
                                                <div class="col-md-4 mb-3" style="display: none"
...
<script type="text/javascript">
    ...
    CuotaInicial.addEventListener("change", function(event) {
        ...
        if (document.getElementById("codTasa").value == '' || document.getElementById("codTasa").value == '031') {
 ...
 //-----------------------------------------CALCULAR IMPUESTO CUOTA------------------------------------------
                    ...
                    success: function(result) {
                            ...
                            success: function(resultado) {
                                ...
                                resultado['response'].forEach(function(
                                    ...
                                    var datos = {
										...
										"flg_dsepultura":servicio["flg_dsepultura"]
                                    }
                        ...
                        setTimeout(function() {
							...
							if (result["response"]["num_cuota_interes"] != '') {
								document.getElementById("cuoIniInt").value=result["response"]["num_cuota_interes"];
								document.getElementById("cuoIniInt").removeAttribute('disabled');
							}
   ...
   /* document.addEventListener("DOMContentLoaded", function() {
    ...
    botonGuarda.addEventListener("click", function() {
		...
		var inicioInt = (document.getElementById("cuoIniInt").value != '') ? parseInt(document.getElementById("cuoIniInt").value) : 0;
                ...
                $.ajax({
                    ...
                    success: function(respuesta) {
                        ...
                        serviciosAgregados.forEach(function(fila) {
							...
							fila['num_cuotas_interes'] = document.getElementById("cuoIniInt").value;
