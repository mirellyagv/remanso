                        ...
                        <div class="card ">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <select name="tipoDocProsp" id="tipoDocProsp"
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <input type="text" class="form-control form-remanso align-right "
                                                        required name="numDocPros" id="numDocPros">
                            ...
                            Debe tener 9 números.
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 mb-3">
                                                        <input type="text"
                                                            ...
                                                            name="nombreProsp" id="nombreProsp" required>
                              ...
                              El nombre no puede estar vacío.
                                                    ...
                                                    <div class="col-md-3 mb-3">
                                                        <input type="text"
                                                            class="form-control form-remanso letras-only"
                                                            name="apellPProsp" id="apellPProsp" required>
                              ...
                              El apellido no puede estar vacío.
                                                    ...
                                                    <div class="col-md-3 mb-3">
                                                        <input type="text"
                                                            class="form-control form-remanso letras-only"
                                                            name="apellMProsp" id="apellMProsp" required>
                              ...
                              El apellido no puede estar vacío.
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9 mb-3">
                                                    <input type="text" class="form-control form-remanso"
                                                        name="direccPros" id="direccPros" required>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-3 mb-3">
                                                ...
                                                <div class="col-md-9 mb-3">
                                                    <input type="text" class="form-control form-remanso"
                                                        name="direccRefPros" id="direccRefPros">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-3 mb-3">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <select name="paisProspecto" id="paisProspecto"
                                                        class="form-select form-remanso" required>
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <select name="dptoProsp" id="dptoProsp"
                                                        class="form-select form-remanso" required>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <select name="provinProsp" id="provinProsp"
                                                        class="form-select form-remanso" required>
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <select name="dttoProsp" id="dttoProsp"
                                                        class="form-select form-remanso" required>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <input type="text"
                                                        class="form-control form-remanso align-right"
                                                        name="telf1Prosp" id="telf1Prosp" min="8"
                                                        max="12" maxlength="12" required>
                            ...
                            El telefono 1 no puede estar vacío.
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9 mb-3">
                                                    <input type="email" class="form-control form-remanso"
                                                        name="correoProsp" id="correoProsp">
                            ...
                            El correo no puede estar vacío.
                                            ...
                                            <div class="row">
                                                <div class="col-md-3 mb-3">
                                                    <label for="inputText" class="col-form-label">(*) Canal de
                                                        venta:</label>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <select name="canalProsp" id="canalProsp"
                                                        class="form-select form-remanso" required>
                                                    </select>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label for="inputText" class="col-form-label">(*) Calificación:
                                                    </label>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <select name="califProsp" id="califProsp"
                                                        class="form-select form-remanso" required>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <input type="text"
                                                        class="form-control form-remanso align-right" name="impProsp"
                                                        id="impProsp" required>
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <select name="tipoDoc2tit" id="tipoDoc2tit"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <select name="pais2Tit" id="pais2Tit"
                                                        class="form-select form-remanso">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <select name="dpto2Tit" id="dpto2Tit"
                                                        class="form-select form-remanso">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <select name="prov2Tit" id="prov2Tit"
                                                        class="form-select form-remanso">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <select name="dtto2Tit" id="dtto2Tit"
                                                        class="form-select form-remanso">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3 offset-md-9">
                                                    <div class="form-group form-remanso">
                                                        <h5><button
                                                                class="btn btn-success BtnverdeRemanso form-remanso"
                          ...
                          <div class="table-responsive">
                            <table class="table table-striped" id="tablaObsv" style="width:100%">
                              ...
                              <tbody style="text-align: center;">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3 mb-3">
                                                    <label for="inputText" class="col-form-label">Fecha de
                                                        contacto:</label>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <input type="text" class="form-control form-remanso" readonly
                                                        value="" name="fchContacto" id="fchContacto">
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label for="inputText" class="col-form-label">(*) Calificación:
                                                    </label>
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <select name="califContacto" id="califContacto"
                                                        class="form-select form-remanso">
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-9 mb-3">
                                                    <textarea class="form-control form-remanso" name="obsvContacto" id="obsvContacto" rows="5"></textarea>
                                                </div>
                                            </div>
        ...
        <div class="modal-dialog  modal-dialog-centered modal-lg modal-dialog-scrollable">
            <div class="modal-content form-remanso">
                <div class="modal-header">
                    <h1 class="modal-title tarjeta-vaca-foco fs-5" id="ModalBeneficiariosLabel">Añadir Beneficiarios
                    </h1>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            <input type="text" class="form-control form-remanso align-right" name="numDocAddBenef"
                                id="numDocAddBenef">
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            <input type="text" class="form-control form-remanso letras-only" name="apellPAddBenef"
                                id="apellPAddBenef">
                        </div>
                        <div class="col-md-3 mb-3">
                        ...
                        <div class="col-md-3 mb-3">
                            <input type="text" class="form-control form-remanso letras-only" name="apellMAddBenef"
                                id="apellMAddBenef">
                        </div>
                        <div class="col-md-3 mb-3">
                ...
                <div class="modal-footer">
                    <button type="button" id="agregaBeneficiario"
                        class="btn btn-primary BtnAzulORemanso form-remanso" data-bs-dismiss="modal">Aceptar</button>
            ...
            <div class="modal-content form-remanso">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            <input type="text" class="form-control form-remanso" name="fechaContacto"
                                id="fechaContacto" readonly>
                        </div>
                        <div class="col-md-3 mb-3">
...
<script type="text/javascript">
    ...
    numDocProsInput.addEventListener("blur", function(event) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: {
                'tipoDoc': document.getElementById("tipoDocProsp").value,
                'dscDocumento': document.getElementById("numDocPros").value
            },
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                var changeEvent = new Event(
                                    'change'); // Crea un evento "change"
                                document.getElementById("rucProsp").value = respuesta[
                                    "response"]["dsc_razon_social"];
                                document.getElementById("apellPProsp").value = respuesta[
                                    "response"]["dsc_apellido_paterno"];
                                document.getElementById("apellMProsp").value = respuesta[
                                    "response"]["dsc_apellido_materno"];
                                document.getElementById("nombreProsp").value = respuesta[
                                    "response"]["dsc_nombre"];
                                var tipoDocPros = document.getElementById("tipoDocProsp");
                                tipoDocPros.value = respuesta["response"][
                                    "cod_tipo_documento"
                                ];

                                document.getElementById("numDocPros").value = respuesta[
                                    "response"]["dsc_documento"];

                                var paisProspecto = document.getElementById(
                                    "paisProspecto");
                                ...
                                document.getElementById("direccPros").value = respuesta[
                                    "response"]["dsc_direccion"];
                                document.getElementById("direccRefPros").value = respuesta[
                                    "response"]["dsc_direccion_referencia"];
                                document.getElementById("telf1Prosp").value = respuesta[
                                    "response"]["dsc_telefono_1"];
                                document.getElementById("telf2Prosp").value = respuesta[
                                    "response"]["dsc_telefono_2"];
                                document.getElementById("correoProsp").value = respuesta[
                                    "response"]["dsc_correo"];
                                ...
                                califProsp.value = respuesta["response"][
                                    "cod_calificacion"
                                ];

                                document.getElementById("obsvProsp").value = respuesta[
                                    "response"]["dsc_observaciones"];
                                document.getElementById("impProsp").value = respuesta[
                                    "response"]["imp_monto"];
    ...
    numDoc2titInput.addEventListener("blur", function(event) {
        $.ajax({
            ...
            dataType: 'json',
            data: {
                'tipoDoc': document.getElementById("tipoDoc2tit").value,
                'dscDocumento': document.getElementById("numDoc2tit").value
            },
            success: function(respuesta) {
                if (respuesta) {
                    document.getElementById("apelP2tit").value = respuesta['response'][
                        'dsc_apellido_paterno'
                    ];
                    document.getElementById("apelM2tit").value = respuesta['response'][
                        'dsc_apellido_materno'
                    ];
                    document.getElementById("nombre2Tit").value = respuesta['response'][
                        'dsc_nombre'
                    ];
                    document.getElementById("ruc2Tit").value = respuesta['response'][
                        'dsc_razon_social'
                    ];
                    document.getElementById("dir2Tit").value = respuesta['response'][
                        'dsc_direccion'
                    ];
                    document.getElementById("telf1_2Tit").value = respuesta['response'][
                        'dsc_telefono_1'
                    ];
                    document.getElementById("telf2_2Tit").value = respuesta['response'][
                        'dsc_telefono_2'
                    ];
                    document.getElementById("correo2Tit").value = respuesta['response'][
                        'dsc_correo'
                    ];
    ...
    actualizarBeneficiario.addEventListener("click", function() {
        ...
        fila.cells[2].textContent = new Date(document.getElementById("fchNacAddBenef").value)
    ...
    boton.addEventListener("click", function() {
        ...
        if (document.getElementById("tipoDocProsp").value == '' || document.getElementById("tipoDocProsp")
            .value == null) {
            Swal.fire({
                title: 'Error!',
        ...
        if (document.getElementById("numDocPros").value == '' || document.getElementById("numDocPros").value ==
            null) {
            Swal.fire({
                title: 'Error!',
        ...
        if (document.getElementById("canalProsp").value == '' || document.getElementById("canalProsp").value ==
            null) {
            Swal.fire({
                title: 'Error!',
        ...
        if (document.getElementById("califProsp").value == '' || document.getElementById("califProsp").value ==
            null) {
            Swal.fire({
                title: 'Error!',
        ...
        if (document.getElementById("impProsp").value == '' || document.getElementById("impProsp").value ==
            null) {
            Swal.fire({
                title: 'Error!',
        ...
        if ((document.getElementById("numDoc2tit").value != '' || document.getElementById("nombre2Tit").value !=
                '' || document.getElementById("apelP2tit").value != '') && (document.getElementById(
                "tipoDoc2tit").value == '' || document.getElementById("tipoDoc2tit").value == null)) {
            Swal.fire({
                title: 'Error!',
        ...
        if ((document.getElementById("tipoDoc2tit").value != '' || document.getElementById("nombre2Tit")
                .value != '' || document.getElementById("apelP2tit").value != '') && (document.getElementById(
                "numDoc2tit").value == '' || document.getElementById("numDoc2tit").value == null)) {
            Swal.fire({
                title: 'Error!',
        ...
        var nombres = (document.getElementById("apellPProsp").value + ' ' + document.getElementById(
            "apellMProsp").value + ', ' + document.getElementById("nombreProsp").value).toUpperCase();
        flgJuridico = '';
        flgJuridico2 = '';
        ...
        var prospecto = {
            ...
            'dsc_prospecto_2do': document.getElementById("nombre2Tit").value.toUpperCase() + ' ' + document
                .getElementById("apelP2tit").value.toUpperCase() + ' ' + document.getElementById(
                    "apelM2tit").value.toUpperCase(),
            ...
            success: function(respuesta) {
                ...
                var promesa = $.ajax({
                    ...
                    data: {
                        ...
                        'dsc_detalle': obsvContacto,
                        'fch_limite': fchContacto
                    },
                    success: function(respuesta) {
                        console.log(respuesta);
                    }, //success
