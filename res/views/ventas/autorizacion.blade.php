...
function listarContratosFirmados(firmado,fchInicio,fchFin) {
    ...
    if ('{{session('flg_firmante')}}' == 'SI') {
        cod_trabajador = '{{session('dsc_usuario')}}';
        ...
        success: function(respuesta){
          var filasArray = [];
            respuesta['response'].forEach(element => {
                ...
                var filaData = [
                    '<button class="btn btn-danger BtnverdeRemanso form-remanso" id="btnVer" onclick="verDocumentos('+codCtto+')" name="btnVer" type="button" title="Ver Documentos"><span class="bi bi-file-pdf"></span></button>'+
