            ...
            <div class="card">
                <div class="row">
                    <div class="col-11 mb-2 d-md-block" style="text-align: center">
                        <button class="btn btn-secondary form-remanso" id="excelBtn1" onclick="IrRegistro()">Registrar
                            Nuevo Telereporte&nbsp; <span class="bi bi-save"></span></button>
                    </div>
                </div>
                        ...
                        <div id="flush-collapseOne" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                <div class="row">
                                    ...
                                    <div class="col-2 mb-3 d-none d-md-block" style="text-align: end">
                                        <button class="btn btn-secondary form-remanso" id="excelBtn1"
                                            onclick="BuscarTelereporte()">Buscar
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 mb-3">
                                        <select name="cod_resultado" id="cod_resultado"
                                            class="form-control form-remanso">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <input type="text" class="form-control form-remanso align-left"
                                            name="dsc_beneficiario" id="dsc_beneficiario">
                                    </div>
    ...
    window.onload = function() {
        ...
        $.ajax({
            ...
            success: function(respuesta) {
                ...
                respuesta['response'].forEach(function(word) {
                    //console.log(word);
                    $("#cod_agencia").append('<option value="' + word['codvar'] + '">' + word[
                        'desvar1'] + '</option>');
                });
            }, //success
            error(e) {
        ...
        $.ajax({
            ...
            success: function(respuesta) {
                ...
                respuesta['response'].forEach(function(word) {
                    //console.log(word);
                    $("#cod_resultado").append('<option value="' + word['codvar'] + '">' + word[
                        'desvar1'] + '</option>');
                });
            }, //success
            error(e) {
    ...
    function BuscarTelereporte() {
        ...
        $.ajax({
            ...
            data: {
                ...
                'dsc_beneficiario': $('#dsc_beneficiario').val(),
                'flg_anulado': $('#flg_anulado').val(),
            ...
            success: function(respuesta) {
                ...
                respuesta['response'].forEach(function(word) {
                    ...
                    var ref = '';
                    ref = 'href="{{ route('telereporte.actualizar') }}?Cod_reporte=' + word[
                        'num_reporte'] + '"';
                    var boton_modificar = '';
                    var boton_estado = '';
                    if (word['flg_anulado'] == "SI" && word['cod_vendedor'] == cod_trabajador) {
                        boton_estado =
                            '<a class="btn btn-danger BtnrojoRemanso form-remanso" onclick="ActivarTelereporte(' +
                            num_reporte +
                            ');" title="Activar"><span class="bi bi-check"></span></a>';
                    } else if (word['flg_anulado'] == "NO" && word['cod_vendedor'] ==
                        cod_trabajador) {
                        boton_estado =
                            '<a class="btn btn-danger BtnredRemanso form-remanso" onclick="AnularTelereporte(' +
                            num_reporte +
                            ');" title="Anular"><span class="bi bi-trash"></span></a>';
                    }

                    if (word['cod_vendedor'] == cod_trabajador) {
                        boton_modificar = '<a class="btn btn-secondary form-remanso" ' + ref +
                            ' title="Modificar"><span class="bi bi-pencil" ></span></a>';
                    } else if (word['cod_vendedor'] != cod_trabajador) {
                        boton_modificar = '<a class="btn btn-secondary form-remanso" ' + ref +
                            ' title="Ver Telereporte"><span class="bi bi-search" ></span></a>';
                    }
                    ...
                    fila += '<tr><td>' +
                        ...
                        '<td>' + word['dsc_nombres'] + ' ' + word['dsc_apellido_paterno'] + ' ' +
                        word['dsc_apellido_materno'] + '</td>' +
        ...
        $.ajax({
            ...
            success: function(respuesta) {
                ...
                if (respuesta['response'].length > 0) {
                    data = [];
                    var header = ['N°', 'FECHA', 'CANAL DE VENTA', 'BENEFICIARIO', 'AGENCIA', 'RESULTADO',
                        'EJECUTIVO'
                    ];
                    respuesta['response'].forEach(element => {
                        ...
                        filaData = [
                            ...
                            element['dsc_nombres'] + ' ' + element['dsc_apellido_paterno'] +
                            ' ' + element['dsc_apellido_materno'],
                            element['dsc_agencia'],
