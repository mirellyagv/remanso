        ...
        success: function(respuesta) {
            ...
            respuesta['response'].forEach(muestra => {
                ...
                if(muestra['dsc_prefijo'] == 'SA'){
                    ...
                    '</tr>'+
                    '</table>';
                }else if (muestra['dsc_prefijo'] == 'CR' || muestra['dsc_prefijo'] == 'FU' || muestra['dsc_prefijo'] == 'SF'){
                    descripcion = '<table class="table tableVisor">'+
                    '<tr>'+
                        '<td style="text-align: center;" colspan = "4"><b>'+muestra['dsc_tipo_autorizacion']+' - '+muestra['num_uso_servicio']+'</b></td>'+
                    '</tr>'+
                    ...
                    '</tr>'+
                    '</table>';
                }else if(muestra['dsc_prefijo'] == 'IN' || muestra['dsc_prefijo'] == 'DU'){
                    descripcion = '<table class="table tableVisor">'+
                    '<tr>'+
                        '<td style="text-align: center;" colspan = "4"><b>'+muestra['dsc_tipo_autorizacion']+' - '+muestra['num_uso_servicio']+'</b></td>'+
                    '</tr>'+
                ...
                if (muestra['dsc_prefijo'] == 'IN' || muestra['dsc_prefijo'] == 'DU' ) {
                    evento = {
                        display:'list-item',
                ...
                } else if (muestra['dsc_prefijo'] == 'SA' || muestra['dsc_prefijo'] == 'FU' || muestra['dsc_prefijo'] == 'SF') {
                    evento = {
                        display:'list-item',
                        title: dscNombres,
                        description: descripcion,
                ...
                }else if (muestra['dsc_prefijo'] == 'OT' || muestra['dsc_prefijo'] == 'CT') {
                    evento = {
                        display:'list-item',
                        title: muestra['dsc_beneficiario_lapida'],
                        description: descripcion,
                ...
                //     };
                // }
                else if (muestra['dsc_prefijo'] == 'CR'){
                    evento = {
                        display:'list-item',
                        title: dscNombres,
                        description: descripcion,
