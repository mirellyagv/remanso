        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div >
                        <span class="bi bi-circle-fill" style="color: #FFC107;"></span>&nbsp;<label for="recipient-name" class="col-form-label">Espacio bloqueado</label>
                    </div>
                    {{-- <div >
                    ...
                    <div >
                        <span class="bi bi-circle-fill" style="color: #05670D;"></span>&nbsp;<label for="recipient-name" class="col-form-label">Espacio Libre</label>
                    </div>
                    <div >
                        <span class="bi bi-circle-fill" style="color: #4FADFF;"></span>&nbsp;<label for="recipient-name" class="col-form-label">Vendido sin beneficiario</label>
                    </div>
                    <div >
                        <span class="bi bi-circle-fill" style="color: #F95050;"></span>&nbsp;<label for="recipient-name" class="col-form-label">Vendido con beneficiario</label>
                    </div>
                </div>
            </div>
        </div>
